...
class MACRXOPTION(object):
    def __init__(self, channel, chipv = "ESP32"):
        ...
        self.__reg_rxlastblock_lk_ena_lsb = 26
        self.__reg_rxlastblock_lk_ena_msb = 26
        self.__reg_rxlastblock_len_ena_lsb = 25
        self.__reg_rxlastblock_len_ena_msb = 25
    ...
    @property
    def reg_rxlastblock_lk_ena(self):
        return self.__MEM.rdm(self.__addr, self.__reg_rxlastblock_lk_ena_msb, self.__reg_rxlastblock_lk_ena_lsb)
    @reg_rxlastblock_lk_ena.setter
    def reg_rxlastblock_lk_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_rxlastblock_lk_ena_msb, self.__reg_rxlastblock_lk_ena_lsb, value)

    @property
    def reg_rxlastblock_len_ena(self):
        return self.__MEM.rdm(self.__addr, self.__reg_rxlastblock_len_ena_msb, self.__reg_rxlastblock_len_ena_lsb)
    @reg_rxlastblock_len_ena.setter
    def reg_rxlastblock_len_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_rxlastblock_len_ena_msb, self.__reg_rxlastblock_len_ena_lsb, value)
...
class MACRX_DATA_DUMP_CONF(object):
    def __init__(self, channel, chipv = "ESP32"):
        ...
        self.__reg_lastbuf_dump_filter0_op_lsb = 11
        self.__reg_lastbuf_dump_filter0_op_msb = 11
        self.__reg_lastbuf_dump_filter1_op_lsb = 10
        self.__reg_lastbuf_dump_filter1_op_msb = 10
        self.__reg_lastbuf_dump_filter2_op_lsb = 9
        self.__reg_lastbuf_dump_filter2_op_msb = 9
        self.__reg_lastbuf_dump_filter0_ena_lsb = 8
        self.__reg_lastbuf_dump_filter0_ena_msb = 8
        self.__reg_lastbuf_dump_filter1_ena_lsb = 7
        self.__reg_lastbuf_dump_filter1_ena_msb = 7
        self.__reg_lastbuf_dump_filter2_ena_lsb = 6
        self.__reg_lastbuf_dump_filter2_ena_msb = 6
        self.__reg_txacktimer_dump_filter0_op_lsb = 5
        self.__reg_txacktimer_dump_filter0_op_msb = 5
        self.__reg_txacktimer_dump_filter1_op_lsb = 4
        self.__reg_txacktimer_dump_filter1_op_msb = 4
        self.__reg_txacktimer_dump_filter2_op_lsb = 3
        self.__reg_txacktimer_dump_filter2_op_msb = 3
        self.__reg_txacktimer_dump_filter0_ena_lsb = 2
        self.__reg_txacktimer_dump_filter0_ena_msb = 2
        self.__reg_txacktimer_dump_filter1_ena_lsb = 1
        self.__reg_txacktimer_dump_filter1_ena_msb = 1
        self.__reg_txacktimer_dump_filter2_ena_lsb = 0
        self.__reg_txacktimer_dump_filter2_ena_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
