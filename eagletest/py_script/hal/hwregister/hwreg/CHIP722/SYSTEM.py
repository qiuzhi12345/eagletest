...
class SYSTEM(object):
    def __init__(self, channel, chipv = "CHIP722"):
        ...
        self.SPI_SHARED_DMA_SEL = SPI_SHARED_DMA_SEL(self.channel, self.chipv)
...
class ROM_CTRL_1(object):
    ...
    @property
    def rom_pd(self):
        return self.__MEM.rdm(self.__addr, self.__rom_pd_msb, self.__rom_pd_lsb)
    @rom_pd.setter
    def rom_pd(self, value):
        return self.__MEM.wrm(self.__addr, self.__rom_pd_msb, self.__rom_pd_lsb, value)
...
class SRAM_CTRL_1(object):
    def __init__(self, channel, chipv = "CHIP722"):
        ...
        self.__sram_pd_lsb = 0
        self.__sram_pd_msb = 21
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def sram_pd(self):
        return self.__MEM.rdm(self.__addr, self.__sram_pd_msb, self.__sram_pd_lsb)
    @sram_pd.setter
    def sram_pd(self, value):
        return self.__MEM.wrm(self.__addr, self.__sram_pd_msb, self.__sram_pd_lsb, value)
class CPU_PERI_CLK_EN(object):
    def __init__(self, channel, chipv = "CHIP722"):
        ...
        self.__clk_en_digital_signature_lsb = 5
        self.__clk_en_digital_signature_msb = 5
        self.__clk_en_hmac_lsb = 4
        self.__clk_en_hmac_msb = 4
        self.__clk_en_secure_boot_lsb = 3
        self.__clk_en_secure_boot_msb = 3
        self.__clk_en_rsa_lsb = 2
        self.__clk_en_rsa_msb = 2
        self.__clk_en_sha_lsb = 1
        self.__clk_en_sha_msb = 1
        self.__clk_en_aes_lsb = 0
        self.__clk_en_aes_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def clk_en_digital_signature(self):
        return self.__MEM.rdm(self.__addr, self.__clk_en_digital_signature_msb, self.__clk_en_digital_signature_lsb)
    @clk_en_digital_signature.setter
    def clk_en_digital_signature(self, value):
        return self.__MEM.wrm(self.__addr, self.__clk_en_digital_signature_msb, self.__clk_en_digital_signature_lsb, value)

    @property
    def clk_en_hmac(self):
        return self.__MEM.rdm(self.__addr, self.__clk_en_hmac_msb, self.__clk_en_hmac_lsb)
    @clk_en_hmac.setter
    def clk_en_hmac(self, value):
        return self.__MEM.wrm(self.__addr, self.__clk_en_hmac_msb, self.__clk_en_hmac_lsb, value)

    @property
    def clk_en_secure_boot(self):
        return self.__MEM.rdm(self.__addr, self.__clk_en_secure_boot_msb, self.__clk_en_secure_boot_lsb)
    @clk_en_secure_boot.setter
    def clk_en_secure_boot(self, value):
        return self.__MEM.wrm(self.__addr, self.__clk_en_secure_boot_msb, self.__clk_en_secure_boot_lsb, value)

    @property
    def clk_en_rsa(self):
        return self.__MEM.rdm(self.__addr, self.__clk_en_rsa_msb, self.__clk_en_rsa_lsb)
    @clk_en_rsa.setter
    def clk_en_rsa(self, value):
        return self.__MEM.wrm(self.__addr, self.__clk_en_rsa_msb, self.__clk_en_rsa_lsb, value)

    @property
    def clk_en_sha(self):
        return self.__MEM.rdm(self.__addr, self.__clk_en_sha_msb, self.__clk_en_sha_lsb)
    @clk_en_sha.setter
    def clk_en_sha(self, value):
        return self.__MEM.wrm(self.__addr, self.__clk_en_sha_msb, self.__clk_en_sha_lsb, value)

    @property
    def clk_en_aes(self):
        return self.__MEM.rdm(self.__addr, self.__clk_en_aes_msb, self.__clk_en_aes_lsb)
    @clk_en_aes.setter
    def clk_en_aes(self, value):
        return self.__MEM.wrm(self.__addr, self.__clk_en_aes_msb, self.__clk_en_aes_lsb, value)
class CPU_PERI_RST_EN(object):
    def __init__(self, channel, chipv = "CHIP722"):
        ...
        self.__rst_en_digital_signature_lsb = 5
        self.__rst_en_digital_signature_msb = 5
        self.__rst_en_hmac_lsb = 4
        self.__rst_en_hmac_msb = 4
        self.__rst_en_secure_boot_lsb = 3
        self.__rst_en_secure_boot_msb = 3
        self.__rst_en_rsa_lsb = 2
        self.__rst_en_rsa_msb = 2
        self.__rst_en_sha_lsb = 1
        self.__rst_en_sha_msb = 1
        self.__rst_en_aes_lsb = 0
        self.__rst_en_aes_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def rst_en_digital_signature(self):
        return self.__MEM.rdm(self.__addr, self.__rst_en_digital_signature_msb, self.__rst_en_digital_signature_lsb)
    @rst_en_digital_signature.setter
    def rst_en_digital_signature(self, value):
        return self.__MEM.wrm(self.__addr, self.__rst_en_digital_signature_msb, self.__rst_en_digital_signature_lsb, value)

    @property
    def rst_en_hmac(self):
        return self.__MEM.rdm(self.__addr, self.__rst_en_hmac_msb, self.__rst_en_hmac_lsb)
    @rst_en_hmac.setter
    def rst_en_hmac(self, value):
        return self.__MEM.wrm(self.__addr, self.__rst_en_hmac_msb, self.__rst_en_hmac_lsb, value)

    @property
    def rst_en_secure_boot(self):
        return self.__MEM.rdm(self.__addr, self.__rst_en_secure_boot_msb, self.__rst_en_secure_boot_lsb)
    @rst_en_secure_boot.setter
    def rst_en_secure_boot(self, value):
        return self.__MEM.wrm(self.__addr, self.__rst_en_secure_boot_msb, self.__rst_en_secure_boot_lsb, value)

    @property
    def rst_en_rsa(self):
        return self.__MEM.rdm(self.__addr, self.__rst_en_rsa_msb, self.__rst_en_rsa_lsb)
    @rst_en_rsa.setter
    def rst_en_rsa(self, value):
        return self.__MEM.wrm(self.__addr, self.__rst_en_rsa_msb, self.__rst_en_rsa_lsb, value)

    @property
    def rst_en_sha(self):
        return self.__MEM.rdm(self.__addr, self.__rst_en_sha_msb, self.__rst_en_sha_lsb)
    @rst_en_sha.setter
    def rst_en_sha(self, value):
        return self.__MEM.wrm(self.__addr, self.__rst_en_sha_msb, self.__rst_en_sha_lsb, value)

    @property
    def rst_en_aes(self):
        return self.__MEM.rdm(self.__addr, self.__rst_en_aes_msb, self.__rst_en_aes_lsb)
    @rst_en_aes.setter
    def rst_en_aes(self, value):
        return self.__MEM.wrm(self.__addr, self.__rst_en_aes_msb, self.__rst_en_aes_lsb, value)
...
class PERIP_CLK_EN1(object):
    def __init__(self, channel, chipv = "CHIP722"):
        ...
        self.__spi_shared_dma_clk_en_lsb = 0
        self.__spi_shared_dma_clk_en_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def spi_shared_dma_clk_en(self):
        return self.__MEM.rdm(self.__addr, self.__spi_shared_dma_clk_en_msb, self.__spi_shared_dma_clk_en_lsb)
    @spi_shared_dma_clk_en.setter
    def spi_shared_dma_clk_en(self, value):
        return self.__MEM.wrm(self.__addr, self.__spi_shared_dma_clk_en_msb, self.__spi_shared_dma_clk_en_lsb, value)
...
class PERIP_RST_EN1(object):
    def __init__(self, channel, chipv = "CHIP722"):
        ...
        self.__spi_shared_dma_rst_lsb = 0
        self.__spi_shared_dma_rst_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def spi_shared_dma_rst(self):
        return self.__MEM.rdm(self.__addr, self.__spi_shared_dma_rst_msb, self.__spi_shared_dma_rst_lsb)
    @spi_shared_dma_rst.setter
    def spi_shared_dma_rst(self, value):
        return self.__MEM.wrm(self.__addr, self.__spi_shared_dma_rst_msb, self.__spi_shared_dma_rst_lsb, value)
...
class SPI_SHARED_DMA_SEL(object):
    def __init__(self, channel, chipv = "CHIP722"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = SYSTEM_BASE + 0x6c
        self.__spi_shared_dma_sel_lsb = 0
        self.__spi_shared_dma_sel_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def spi_shared_dma_sel(self):
        return self.__MEM.rdm(self.__addr, self.__spi_shared_dma_sel_msb, self.__spi_shared_dma_sel_lsb)
    @spi_shared_dma_sel.setter
    def spi_shared_dma_sel(self, value):
        return self.__MEM.wrm(self.__addr, self.__spi_shared_dma_sel_msb, self.__spi_shared_dma_sel_lsb, value)
