...
class MACBB_INIT_VALUE(object):
    def __init__(self, channel, chipv = "FPGA11ac"):
        ...
        self.__reg_bb_cca_ind_ht80_sec_lsb = 20
        self.__reg_bb_cca_ind_ht80_sec_msb = 21
    ...
    @property
    def reg_bb_cca_ind_ht80_sec(self):
        return self.__MEM.rdm(self.__addr, self.__reg_bb_cca_ind_ht80_sec_msb, self.__reg_bb_cca_ind_ht80_sec_lsb)
    @reg_bb_cca_ind_ht80_sec.setter
    def reg_bb_cca_ind_ht80_sec(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_bb_cca_ind_ht80_sec_msb, self.__reg_bb_cca_ind_ht80_sec_lsb, value)
...
class MACSECOND_CCACONF(object):
    def __init__(self, channel, chipv = "FPGA11ac"):
        ...
        self.__reg_sec_40m_cca_count_lsb = 8
        self.__reg_sec_40m_cca_count_msb = 15
        self.__reg_sec_20m_cca_count_lsb = 0
        self.__reg_sec_20m_cca_count_msb = 7
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_sec_40m_cca_count(self):
        return self.__MEM.rdm(self.__addr, self.__reg_sec_40m_cca_count_msb, self.__reg_sec_40m_cca_count_lsb)
    @reg_sec_40m_cca_count.setter
    def reg_sec_40m_cca_count(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_sec_40m_cca_count_msb, self.__reg_sec_40m_cca_count_lsb, value)

    @property
    def reg_sec_20m_cca_count(self):
        return self.__MEM.rdm(self.__addr, self.__reg_sec_20m_cca_count_msb, self.__reg_sec_20m_cca_count_lsb)
    @reg_sec_20m_cca_count.setter
    def reg_sec_20m_cca_count(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_sec_20m_cca_count_msb, self.__reg_sec_20m_cca_count_lsb, value)
