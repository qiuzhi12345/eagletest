...
class RTC_CNTL(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.RTC_TOUCH_TIMEOUT_CTRL = RTC_TOUCH_TIMEOUT_CTRL(self.channel, self.chipv)
        self.RTC_SLP_REJECT_CAUSE = RTC_SLP_REJECT_CAUSE(self.channel, self.chipv)
        self.RTC_OPTION1 = RTC_OPTION1(self.channel, self.chipv)
        self.RTC_SLP_WAKEUP_CAUSE = RTC_SLP_WAKEUP_CAUSE(self.channel, self.chipv)
        self.RTC_ULP_CP_TIMER_1 = RTC_ULP_CP_TIMER_1(self.channel, self.chipv)
...
class RTC_OPTIONS0(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_xtl_en_wait_lsb = 14
        self.__reg_xtl_en_wait_msb = 17
    ...
    @property
    def reg_xtl_en_wait(self):
        return self.__MEM.rdm(self.__addr, self.__reg_xtl_en_wait_msb, self.__reg_xtl_en_wait_lsb)
    @reg_xtl_en_wait.setter
    def reg_xtl_en_wait(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_xtl_en_wait_msb, self.__reg_xtl_en_wait_lsb, value)
...
class RTC_SLP_TIMER1(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__rtc_main_timer_alarm_en_lsb = 16
        self.__rtc_main_timer_alarm_en_msb = 16
    ...
    @property
    def rtc_main_timer_alarm_en(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_main_timer_alarm_en_msb, self.__rtc_main_timer_alarm_en_lsb)
    @rtc_main_timer_alarm_en.setter
    def rtc_main_timer_alarm_en(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_main_timer_alarm_en_msb, self.__rtc_main_timer_alarm_en_lsb, value)
...
class RTC_ANA_CONF(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_sar_i2c_force_pu_lsb = 22
        self.__reg_sar_i2c_force_pu_msb = 22
        self.__reg_sar_i2c_force_pd_lsb = 21
        self.__reg_sar_i2c_force_pd_msb = 21
        self.__reg_glitch_rst_en_lsb = 20
        self.__reg_glitch_rst_en_msb = 20
        self.__reg_i2c_reset_por_force_pu_lsb = 19
        self.__reg_i2c_reset_por_force_pu_msb = 19
        self.__reg_i2c_reset_por_force_pd_lsb = 18
        self.__reg_i2c_reset_por_force_pd_msb = 18
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_sar_i2c_force_pu(self):
        return self.__MEM.rdm(self.__addr, self.__reg_sar_i2c_force_pu_msb, self.__reg_sar_i2c_force_pu_lsb)
    @reg_sar_i2c_force_pu.setter
    def reg_sar_i2c_force_pu(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_sar_i2c_force_pu_msb, self.__reg_sar_i2c_force_pu_lsb, value)

    @property
    def reg_sar_i2c_force_pd(self):
        return self.__MEM.rdm(self.__addr, self.__reg_sar_i2c_force_pd_msb, self.__reg_sar_i2c_force_pd_lsb)
    @reg_sar_i2c_force_pd.setter
    def reg_sar_i2c_force_pd(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_sar_i2c_force_pd_msb, self.__reg_sar_i2c_force_pd_lsb, value)

    @property
    def reg_glitch_rst_en(self):
        return self.__MEM.rdm(self.__addr, self.__reg_glitch_rst_en_msb, self.__reg_glitch_rst_en_lsb)
    @reg_glitch_rst_en.setter
    def reg_glitch_rst_en(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_glitch_rst_en_msb, self.__reg_glitch_rst_en_lsb, value)

    @property
    def reg_i2c_reset_por_force_pu(self):
        return self.__MEM.rdm(self.__addr, self.__reg_i2c_reset_por_force_pu_msb, self.__reg_i2c_reset_por_force_pu_lsb)
    @reg_i2c_reset_por_force_pu.setter
    def reg_i2c_reset_por_force_pu(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_i2c_reset_por_force_pu_msb, self.__reg_i2c_reset_por_force_pu_lsb, value)

    @property
    def reg_i2c_reset_por_force_pd(self):
        return self.__MEM.rdm(self.__addr, self.__reg_i2c_reset_por_force_pd_msb, self.__reg_i2c_reset_por_force_pd_lsb)
    @reg_i2c_reset_por_force_pd.setter
    def reg_i2c_reset_por_force_pd(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_i2c_reset_por_force_pd_msb, self.__reg_i2c_reset_por_force_pd_lsb, value)
...
class RTC_WAKEUP_STATE(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_rtc_wakeup_ena_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
...
class INT_ENA_RTC(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__rtc_glitch_det_int_ena_lsb = 19
        self.__rtc_glitch_det_int_ena_msb = 19
        self.__rtc_touch_timeout_int_ena_lsb = 18
        self.__rtc_touch_timeout_int_ena_msb = 18
        ...
        self.__rtc_touch_scan_done_int_ena_lsb = 4
        self.__rtc_touch_scan_done_int_ena_msb = 4
    ...
    @property
    def rtc_glitch_det_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_glitch_det_int_ena_msb, self.__rtc_glitch_det_int_ena_lsb)
    @rtc_glitch_det_int_ena.setter
    def rtc_glitch_det_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_glitch_det_int_ena_msb, self.__rtc_glitch_det_int_ena_lsb, value)

    @property
    def rtc_touch_timeout_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_touch_timeout_int_ena_msb, self.__rtc_touch_timeout_int_ena_lsb)
    @rtc_touch_timeout_int_ena.setter
    def rtc_touch_timeout_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_touch_timeout_int_ena_msb, self.__rtc_touch_timeout_int_ena_lsb, value)
    ...
    @property
    def rtc_touch_scan_done_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_touch_scan_done_int_ena_msb, self.__rtc_touch_scan_done_int_ena_lsb)
    @rtc_touch_scan_done_int_ena.setter
    def rtc_touch_scan_done_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_touch_scan_done_int_ena_msb, self.__rtc_touch_scan_done_int_ena_lsb, value)
...
class INT_RAW_RTC(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__rtc_glitch_det_int_raw_lsb = 19
        self.__rtc_glitch_det_int_raw_msb = 19
        self.__rtc_touch_timeout_int_raw_lsb = 18
        self.__rtc_touch_timeout_int_raw_msb = 18
        ...
        self.__rtc_touch_scan_done_int_raw_lsb = 4
        self.__rtc_touch_scan_done_int_raw_msb = 4
    ...
    @property
    def rtc_glitch_det_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_glitch_det_int_raw_msb, self.__rtc_glitch_det_int_raw_lsb)
    @rtc_glitch_det_int_raw.setter
    def rtc_glitch_det_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_glitch_det_int_raw_msb, self.__rtc_glitch_det_int_raw_lsb, value)

    @property
    def rtc_touch_timeout_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_touch_timeout_int_raw_msb, self.__rtc_touch_timeout_int_raw_lsb)
    @rtc_touch_timeout_int_raw.setter
    def rtc_touch_timeout_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_touch_timeout_int_raw_msb, self.__rtc_touch_timeout_int_raw_lsb, value)
    ...
    @property
    def rtc_touch_scan_done_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_touch_scan_done_int_raw_msb, self.__rtc_touch_scan_done_int_raw_lsb)
    @rtc_touch_scan_done_int_raw.setter
    def rtc_touch_scan_done_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_touch_scan_done_int_raw_msb, self.__rtc_touch_scan_done_int_raw_lsb, value)
...
class INT_ST_RTC(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__rtc_glitch_det_int_st_lsb = 19
        self.__rtc_glitch_det_int_st_msb = 19
        self.__rtc_touch_timeout_int_st_lsb = 18
        self.__rtc_touch_timeout_int_st_msb = 18
        ...
        self.__rtc_touch_scan_done_int_st_lsb = 4
        self.__rtc_touch_scan_done_int_st_msb = 4
    ...
    @property
    def rtc_glitch_det_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_glitch_det_int_st_msb, self.__rtc_glitch_det_int_st_lsb)
    @rtc_glitch_det_int_st.setter
    def rtc_glitch_det_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_glitch_det_int_st_msb, self.__rtc_glitch_det_int_st_lsb, value)

    @property
    def rtc_touch_timeout_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_touch_timeout_int_st_msb, self.__rtc_touch_timeout_int_st_lsb)
    @rtc_touch_timeout_int_st.setter
    def rtc_touch_timeout_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_touch_timeout_int_st_msb, self.__rtc_touch_timeout_int_st_lsb, value)
    ...
    @property
    def rtc_touch_scan_done_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_touch_scan_done_int_st_msb, self.__rtc_touch_scan_done_int_st_lsb)
    @rtc_touch_scan_done_int_st.setter
    def rtc_touch_scan_done_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_touch_scan_done_int_st_msb, self.__rtc_touch_scan_done_int_st_lsb, value)
...
class INT_CLR_RTC(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__rtc_glitch_det_int_clr_lsb = 19
        self.__rtc_glitch_det_int_clr_msb = 19
        self.__rtc_touch_timeout_int_clr_lsb = 18
        self.__rtc_touch_timeout_int_clr_msb = 18
        ...
        self.__rtc_touch_scan_done_int_clr_lsb = 4
        self.__rtc_touch_scan_done_int_clr_msb = 4
    ...
    @property
    def rtc_glitch_det_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_glitch_det_int_clr_msb, self.__rtc_glitch_det_int_clr_lsb)
    @rtc_glitch_det_int_clr.setter
    def rtc_glitch_det_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_glitch_det_int_clr_msb, self.__rtc_glitch_det_int_clr_lsb, value)

    @property
    def rtc_touch_timeout_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_touch_timeout_int_clr_msb, self.__rtc_touch_timeout_int_clr_lsb)
    @rtc_touch_timeout_int_clr.setter
    def rtc_touch_timeout_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_touch_timeout_int_clr_msb, self.__rtc_touch_timeout_int_clr_lsb, value)
    ...
    @property
    def rtc_touch_scan_done_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__rtc_touch_scan_done_int_clr_msb, self.__rtc_touch_scan_done_int_clr_lsb)
    @rtc_touch_scan_done_int_clr.setter
    def rtc_touch_scan_done_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__rtc_touch_scan_done_int_clr_msb, self.__rtc_touch_scan_done_int_clr_lsb, value)
...
class RTC_EXT_XTL_CONF(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_rtc_wdt_state_lsb = 20
        self.__reg_rtc_wdt_state_msb = 22
        self.__reg_dac_xtal_32k_lsb = 17
        self.__reg_dac_xtal_32k_msb = 19
    ...
    @property
    def reg_rtc_wdt_state(self):
        return self.__MEM.rdm(self.__addr, self.__reg_rtc_wdt_state_msb, self.__reg_rtc_wdt_state_lsb)
    @reg_rtc_wdt_state.setter
    def reg_rtc_wdt_state(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_rtc_wdt_state_msb, self.__reg_rtc_wdt_state_lsb, value)
...
class RTC_EXT_WAKEUP_CONF(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_gpio_wakeup_filter_lsb = 29
        self.__reg_gpio_wakeup_filter_msb = 29
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
...
class RTC_SLP_REJECT_CONF(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_rtc_sleep_reject_ena_lsb = 13
...
class RTC_BIAS_CONF(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_dbg_atten_monitor_lsb = 22
        self.__reg_dbg_atten_monitor_msb = 25
        self.__reg_dbg_atten_deep_slp_lsb = 18
        self.__reg_dbg_atten_deep_slp_msb = 21
        self.__reg_bias_sleep_monitor_lsb = 17
        self.__reg_bias_sleep_monitor_msb = 17
        self.__reg_bias_sleep_deep_slp_lsb = 16
        self.__reg_bias_sleep_deep_slp_msb = 16
        self.__reg_pd_cur_monitor_lsb = 15
        self.__reg_pd_cur_monitor_msb = 15
        self.__reg_pd_cur_deep_slp_lsb = 14
        self.__reg_pd_cur_deep_slp_msb = 14
        self.__reg_bias_buf_monitor_lsb = 13
        self.__reg_bias_buf_monitor_msb = 13
        self.__reg_bias_buf_deep_slp_lsb = 12
        self.__reg_bias_buf_deep_slp_msb = 12
        self.__reg_bias_buf_wake_lsb = 11
        self.__reg_bias_buf_wake_msb = 11
        self.__reg_bias_buf_idle_lsb = 10
        self.__reg_bias_buf_idle_msb = 10
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_dbg_atten_monitor(self):
        return self.__MEM.rdm(self.__addr, self.__reg_dbg_atten_monitor_msb, self.__reg_dbg_atten_monitor_lsb)
    @reg_dbg_atten_monitor.setter
    def reg_dbg_atten_monitor(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_dbg_atten_monitor_msb, self.__reg_dbg_atten_monitor_lsb, value)

    @property
    def reg_dbg_atten_deep_slp(self):
        return self.__MEM.rdm(self.__addr, self.__reg_dbg_atten_deep_slp_msb, self.__reg_dbg_atten_deep_slp_lsb)
    @reg_dbg_atten_deep_slp.setter
    def reg_dbg_atten_deep_slp(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_dbg_atten_deep_slp_msb, self.__reg_dbg_atten_deep_slp_lsb, value)

    @property
    def reg_bias_sleep_monitor(self):
        return self.__MEM.rdm(self.__addr, self.__reg_bias_sleep_monitor_msb, self.__reg_bias_sleep_monitor_lsb)
    @reg_bias_sleep_monitor.setter
    def reg_bias_sleep_monitor(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_bias_sleep_monitor_msb, self.__reg_bias_sleep_monitor_lsb, value)

    @property
    def reg_bias_sleep_deep_slp(self):
        return self.__MEM.rdm(self.__addr, self.__reg_bias_sleep_deep_slp_msb, self.__reg_bias_sleep_deep_slp_lsb)
    @reg_bias_sleep_deep_slp.setter
    def reg_bias_sleep_deep_slp(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_bias_sleep_deep_slp_msb, self.__reg_bias_sleep_deep_slp_lsb, value)

    @property
    def reg_pd_cur_monitor(self):
        return self.__MEM.rdm(self.__addr, self.__reg_pd_cur_monitor_msb, self.__reg_pd_cur_monitor_lsb)
    @reg_pd_cur_monitor.setter
    def reg_pd_cur_monitor(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_pd_cur_monitor_msb, self.__reg_pd_cur_monitor_lsb, value)

    @property
    def reg_pd_cur_deep_slp(self):
        return self.__MEM.rdm(self.__addr, self.__reg_pd_cur_deep_slp_msb, self.__reg_pd_cur_deep_slp_lsb)
    @reg_pd_cur_deep_slp.setter
    def reg_pd_cur_deep_slp(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_pd_cur_deep_slp_msb, self.__reg_pd_cur_deep_slp_lsb, value)

    @property
    def reg_bias_buf_monitor(self):
        return self.__MEM.rdm(self.__addr, self.__reg_bias_buf_monitor_msb, self.__reg_bias_buf_monitor_lsb)
    @reg_bias_buf_monitor.setter
    def reg_bias_buf_monitor(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_bias_buf_monitor_msb, self.__reg_bias_buf_monitor_lsb, value)

    @property
    def reg_bias_buf_deep_slp(self):
        return self.__MEM.rdm(self.__addr, self.__reg_bias_buf_deep_slp_msb, self.__reg_bias_buf_deep_slp_lsb)
    @reg_bias_buf_deep_slp.setter
    def reg_bias_buf_deep_slp(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_bias_buf_deep_slp_msb, self.__reg_bias_buf_deep_slp_lsb, value)

    @property
    def reg_bias_buf_wake(self):
        return self.__MEM.rdm(self.__addr, self.__reg_bias_buf_wake_msb, self.__reg_bias_buf_wake_lsb)
    @reg_bias_buf_wake.setter
    def reg_bias_buf_wake(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_bias_buf_wake_msb, self.__reg_bias_buf_wake_lsb, value)

    @property
    def reg_bias_buf_idle(self):
        return self.__MEM.rdm(self.__addr, self.__reg_bias_buf_idle_msb, self.__reg_bias_buf_idle_lsb)
    @reg_bias_buf_idle.setter
    def reg_bias_buf_idle(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_bias_buf_idle_msb, self.__reg_bias_buf_idle_lsb, value)
...
class RTC_BROWN_OUT(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_brown_out_rst_sel_lsb = 27
        self.__reg_brown_out_rst_sel_msb = 27
        ...
        self.__reg_brown_out2_ena_lsb = 0
        self.__reg_brown_out2_ena_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_brown_out_rst_sel(self):
        return self.__MEM.rdm(self.__addr, self.__reg_brown_out_rst_sel_msb, self.__reg_brown_out_rst_sel_lsb)
    @reg_brown_out_rst_sel.setter
    def reg_brown_out_rst_sel(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_brown_out_rst_sel_msb, self.__reg_brown_out_rst_sel_lsb, value)
    ...
    @property
    def reg_brown_out2_ena(self):
        return self.__MEM.rdm(self.__addr, self.__reg_brown_out2_ena_msb, self.__reg_brown_out2_ena_lsb)
    @reg_brown_out2_ena.setter
    def reg_brown_out2_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_brown_out2_ena_msb, self.__reg_brown_out2_ena_lsb, value)
...
class RTC_COCPU_CTRL(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_cocpu_sw_int_trigger_lsb = 26
        self.__reg_cocpu_sw_int_trigger_msb = 26
        self.__reg_cocpu_done_lsb = 25
        self.__reg_cocpu_done_msb = 25
        self.__reg_cocpu_done_force_lsb = 24
        self.__reg_cocpu_done_force_msb = 24
        self.__reg_cocpu_sel_lsb = 23
        self.__reg_cocpu_sel_msb = 23
        self.__reg_cocpu_shut_reset_en_lsb = 22
        self.__reg_cocpu_shut_reset_en_msb = 22
        self.__reg_cocpu_shut_2_clk_dis_lsb = 14
        self.__reg_cocpu_shut_2_clk_dis_msb = 21
...
class RTC_TOUCH_CTRL2(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_touch_timer_force_done_lsb = 27
        self.__reg_touch_timer_force_done_msb = 28
        ...
        self.__reg_touch_dbias_lsb = 12
        self.__reg_touch_dbias_msb = 12
    ...
    @property
    def reg_touch_timer_force_done(self):
        return self.__MEM.rdm(self.__addr, self.__reg_touch_timer_force_done_msb, self.__reg_touch_timer_force_done_lsb)
    @reg_touch_timer_force_done.setter
    def reg_touch_timer_force_done(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_touch_timer_force_done_msb, self.__reg_touch_timer_force_done_lsb, value)
    ...
    @property
    def reg_touch_dbias(self):
        return self.__MEM.rdm(self.__addr, self.__reg_touch_dbias_msb, self.__reg_touch_dbias_lsb)
    @reg_touch_dbias.setter
    def reg_touch_dbias(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_touch_dbias_msb, self.__reg_touch_dbias_lsb, value)
...
class RTC_TOUCH_FILTER_CTRL(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_touch_filter_mode_lsb = 28
        self.__reg_touch_filter_mode_msb = 30
        self.__reg_touch_debounce_lsb = 25
        self.__reg_touch_debounce_msb = 27
        self.__reg_touch_hysteresis_lsb = 23
        self.__reg_touch_hysteresis_msb = 24
        self.__reg_touch_noise_thres_lsb = 21
        self.__reg_touch_noise_thres_msb = 22
        self.__reg_touch_neg_noise_thres_lsb = 19
        self.__reg_touch_neg_noise_thres_msb = 20
        self.__reg_touch_neg_noise_limit_lsb = 15
        self.__reg_touch_neg_noise_limit_msb = 18
        self.__reg_touch_jitter_step_lsb = 11
        self.__reg_touch_jitter_step_msb = 14
        self.__reg_touch_smooth_lvl_lsb = 9
        self.__reg_touch_smooth_lvl_msb = 10
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_touch_smooth_lvl(self):
        return self.__MEM.rdm(self.__addr, self.__reg_touch_smooth_lvl_msb, self.__reg_touch_smooth_lvl_lsb)
    @reg_touch_smooth_lvl.setter
    def reg_touch_smooth_lvl(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_touch_smooth_lvl_msb, self.__reg_touch_smooth_lvl_lsb, value)
class RTC_USB_CONF(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_io_mux_reset_disable_lsb = 18
        self.__reg_io_mux_reset_disable_msb = 18
        self.__reg_usb_reset_disable_lsb = 17
        self.__reg_usb_reset_disable_msb = 17
    ...
    @property
    def reg_io_mux_reset_disable(self):
        return self.__MEM.rdm(self.__addr, self.__reg_io_mux_reset_disable_msb, self.__reg_io_mux_reset_disable_lsb)
    @reg_io_mux_reset_disable.setter
    def reg_io_mux_reset_disable(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_io_mux_reset_disable_msb, self.__reg_io_mux_reset_disable_lsb, value)

    @property
    def reg_usb_reset_disable(self):
        return self.__MEM.rdm(self.__addr, self.__reg_usb_reset_disable_msb, self.__reg_usb_reset_disable_lsb)
    @reg_usb_reset_disable.setter
    def reg_usb_reset_disable(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_usb_reset_disable_msb, self.__reg_usb_reset_disable_lsb, value)
...
class RTC_TOUCH_TIMEOUT_CTRL(object):
    def __init__(self, channel, chipv = "CHIP723"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = RTC_CNTL_BASE + 0x120
        self.__reg_touch_timeout_en_lsb = 22
        self.__reg_touch_timeout_en_msb = 22
        self.__reg_touch_timeout_num_lsb = 0
        self.__reg_touch_timeout_num_msb = 21
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_touch_timeout_en(self):
        return self.__MEM.rdm(self.__addr, self.__reg_touch_timeout_en_msb, self.__reg_touch_timeout_en_lsb)
    @reg_touch_timeout_en.setter
    def reg_touch_timeout_en(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_touch_timeout_en_msb, self.__reg_touch_timeout_en_lsb, value)

    @property
    def reg_touch_timeout_num(self):
        return self.__MEM.rdm(self.__addr, self.__reg_touch_timeout_num_msb, self.__reg_touch_timeout_num_lsb)
    @reg_touch_timeout_num.setter
    def reg_touch_timeout_num(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_touch_timeout_num_msb, self.__reg_touch_timeout_num_lsb, value)
class RTC_SLP_REJECT_CAUSE(object):
    def __init__(self, channel, chipv = "CHIP723"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
...
class RTC_OPTION1(object):
    def __init__(self, channel, chipv = "CHIP723"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = RTC_CNTL_BASE + 0x128
        self.__reg_force_download_boot_lsb = 0
        self.__reg_force_download_boot_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_force_download_boot(self):
        return self.__MEM.rdm(self.__addr, self.__reg_force_download_boot_msb, self.__reg_force_download_boot_lsb)
    @reg_force_download_boot.setter
    def reg_force_download_boot(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_force_download_boot_msb, self.__reg_force_download_boot_lsb, value)
class RTC_SLP_WAKEUP_CAUSE(object):
    def __init__(self, channel, chipv = "CHIP723"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = RTC_CNTL_BASE + 0x12c
        self.__wakeup_cause_lsb = 0
        self.__wakeup_cause_msb = 16
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
...
class RTC_ULP_CP_TIMER_1(object):
    def __init__(self, channel, chipv = "CHIP723"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = RTC_CNTL_BASE + 0x130
        self.__reg_ulp_cp_timer_slp_cycle_lsb = 8
        self.__reg_ulp_cp_timer_slp_cycle_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
...
class RTC_CNTL_DATE(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = RTC_CNTL_BASE + 0x138
