...
class I2SINT_RAW(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__i2s_v_sync_int_raw_lsb = 17
        self.__i2s_v_sync_int_raw_msb = 17
    ...
    @property
    def i2s_v_sync_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__i2s_v_sync_int_raw_msb, self.__i2s_v_sync_int_raw_lsb)
    @i2s_v_sync_int_raw.setter
    def i2s_v_sync_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__i2s_v_sync_int_raw_msb, self.__i2s_v_sync_int_raw_lsb, value)
...
class I2SINT_ST(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__i2s_v_sync_int_st_lsb = 17
        self.__i2s_v_sync_int_st_msb = 17
    ...
    @property
    def i2s_v_sync_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__i2s_v_sync_int_st_msb, self.__i2s_v_sync_int_st_lsb)
    @i2s_v_sync_int_st.setter
    def i2s_v_sync_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__i2s_v_sync_int_st_msb, self.__i2s_v_sync_int_st_lsb, value)
...
class I2SINT_ENA(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__i2s_v_sync_int_ena_lsb = 17
        self.__i2s_v_sync_int_ena_msb = 17
    ...
    @property
    def i2s_v_sync_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__i2s_v_sync_int_ena_msb, self.__i2s_v_sync_int_ena_lsb)
    @i2s_v_sync_int_ena.setter
    def i2s_v_sync_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__i2s_v_sync_int_ena_msb, self.__i2s_v_sync_int_ena_lsb, value)
...
class I2SINT_CLR(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__i2s_v_sync_int_clr_lsb = 17
        self.__i2s_v_sync_int_clr_msb = 17
    ...
    @property
    def i2s_v_sync_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__i2s_v_sync_int_clr_msb, self.__i2s_v_sync_int_clr_lsb)
    @i2s_v_sync_int_clr.setter
    def i2s_v_sync_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__i2s_v_sync_int_clr_msb, self.__i2s_v_sync_int_clr_lsb, value)
...
class I2S_LC_CONF(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__i2s_ext_mem_bk_size_lsb = 14
        self.__i2s_ext_mem_bk_size_msb = 15
    ...
    @property
    def i2s_ext_mem_bk_size(self):
        return self.__MEM.rdm(self.__addr, self.__i2s_ext_mem_bk_size_msb, self.__i2s_ext_mem_bk_size_lsb)
    @i2s_ext_mem_bk_size.setter
    def i2s_ext_mem_bk_size(self, value):
        return self.__MEM.wrm(self.__addr, self.__i2s_ext_mem_bk_size_msb, self.__i2s_ext_mem_bk_size_lsb, value)
...
class I2S_PD_CONF(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.__reg_dma_ram_clk_fo_lsb = 6
        self.__reg_dma_ram_clk_fo_msb = 6
        self.__reg_dma_ram_force_pu_lsb = 5
        self.__reg_dma_ram_force_pu_msb = 5
        self.__reg_dma_ram_force_pd_lsb = 4
        self.__reg_dma_ram_force_pd_msb = 4
    ...
    @property
    def reg_dma_ram_clk_fo(self):
        return self.__MEM.rdm(self.__addr, self.__reg_dma_ram_clk_fo_msb, self.__reg_dma_ram_clk_fo_lsb)
    @reg_dma_ram_clk_fo.setter
    def reg_dma_ram_clk_fo(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_dma_ram_clk_fo_msb, self.__reg_dma_ram_clk_fo_lsb, value)

    @property
    def reg_dma_ram_force_pu(self):
        return self.__MEM.rdm(self.__addr, self.__reg_dma_ram_force_pu_msb, self.__reg_dma_ram_force_pu_lsb)
    @reg_dma_ram_force_pu.setter
    def reg_dma_ram_force_pu(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_dma_ram_force_pu_msb, self.__reg_dma_ram_force_pu_lsb, value)

    @property
    def reg_dma_ram_force_pd(self):
        return self.__MEM.rdm(self.__addr, self.__reg_dma_ram_force_pd_msb, self.__reg_dma_ram_force_pd_lsb)
    @reg_dma_ram_force_pd.setter
    def reg_dma_ram_force_pd(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_dma_ram_force_pd_msb, self.__reg_dma_ram_force_pd_lsb, value)
