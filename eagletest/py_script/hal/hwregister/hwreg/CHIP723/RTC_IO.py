...
class RTC_IO(object):
    def __init__(self, channel, chipv = "CHIP723"):
        ...
        self.RTC_IO_TOUCH_CTRL = RTC_IO_TOUCH_CTRL(self.channel, self.chipv)
...
class RTC_IO_TOUCH_CTRL(object):
    def __init__(self, channel, chipv = "CHIP723"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = RTC_IO_BASE + 0xe8
        self.__reg_io_touch_bufmode_lsb = 4
        self.__reg_io_touch_bufmode_msb = 4
        self.__reg_io_touch_bufsel_lsb = 0
        self.__reg_io_touch_bufsel_msb = 3
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_io_touch_bufmode(self):
        return self.__MEM.rdm(self.__addr, self.__reg_io_touch_bufmode_msb, self.__reg_io_touch_bufmode_lsb)
    @reg_io_touch_bufmode.setter
    def reg_io_touch_bufmode(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_io_touch_bufmode_msb, self.__reg_io_touch_bufmode_lsb, value)

    @property
    def reg_io_touch_bufsel(self):
        return self.__MEM.rdm(self.__addr, self.__reg_io_touch_bufsel_msb, self.__reg_io_touch_bufsel_lsb)
    @reg_io_touch_bufsel.setter
    def reg_io_touch_bufsel(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_io_touch_bufsel_msb, self.__reg_io_touch_bufsel_lsb, value)
