...
class MAC_SCH(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.MACDELAY1 = MACDELAY1(self.channel, self.chipv)
        ...
        self.MACAHBRG_HI = MACAHBRG_HI(self.channel, self.chipv)
        self.MACAHBRG_LO = MACAHBRG_LO(self.channel, self.chipv)
        ...
        self.MACTXQ_MAINTAIN_CLR = MACTXQ_MAINTAIN_CLR(self.channel, self.chipv)
        ...
        self.MACAUTOACK_TIME_VALID_CLR = MACAUTOACK_TIME_VALID_CLR(self.channel, self.chipv)
        self.MACAUTOACK_TIME_VALID = MACAUTOACK_TIME_VALID(self.channel, self.chipv)
        self.MACAUTOACK_TIMER0_US = MACAUTOACK_TIMER0_US(self.channel, self.chipv)
        self.MACAUTOACK_TIMER0_CYC = MACAUTOACK_TIMER0_CYC(self.channel, self.chipv)
        self.MACAUTOACK_TIMER1_US = MACAUTOACK_TIMER1_US(self.channel, self.chipv)
        self.MACAUTOACK_TIMER1_CYC = MACAUTOACK_TIMER1_CYC(self.channel, self.chipv)
        self.MACAUTOACK_TIMER2_US = MACAUTOACK_TIMER2_US(self.channel, self.chipv)
        self.MACAUTOACK_TIMER2_CYC = MACAUTOACK_TIMER2_CYC(self.channel, self.chipv)
        self.MACAUTOACK_TIMER3_US = MACAUTOACK_TIMER3_US(self.channel, self.chipv)
        self.MACAUTOACK_TIMER3_CYC = MACAUTOACK_TIMER3_CYC(self.channel, self.chipv)
        self.MACAUTOACK_TIMER4_US = MACAUTOACK_TIMER4_US(self.channel, self.chipv)
        self.MACAUTOACK_TIMER4_CYC = MACAUTOACK_TIMER4_CYC(self.channel, self.chipv)
        self.MACAUTOACK_TIMER5_US = MACAUTOACK_TIMER5_US(self.channel, self.chipv)
        self.MACAUTOACK_TIMER5_CYC = MACAUTOACK_TIMER5_CYC(self.channel, self.chipv)
...
class INT1_NMI_MAC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__txmachung_int_nmi_lsb = 10
        self.__txmachung_int_nmi_msb = 10
    ...
    @property
    def txmachung_int_nmi(self):
        return self.__MEM.rdm(self.__addr, self.__txmachung_int_nmi_msb, self.__txmachung_int_nmi_lsb)
    @txmachung_int_nmi.setter
    def txmachung_int_nmi(self, value):
        return self.__MEM.wrm(self.__addr, self.__txmachung_int_nmi_msb, self.__txmachung_int_nmi_lsb, value)
...
class INT1_ENA_MAC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__txmachung_int_ena_lsb = 10
        self.__txmachung_int_ena_msb = 10
    ...
    @property
    def txmachung_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__txmachung_int_ena_msb, self.__txmachung_int_ena_lsb)
    @txmachung_int_ena.setter
    def txmachung_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__txmachung_int_ena_msb, self.__txmachung_int_ena_lsb, value)
...
class INT1_RAW_MAC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__txmachung_int_raw_lsb = 10
        self.__txmachung_int_raw_msb = 10
    ...
    @property
    def txmachung_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__txmachung_int_raw_msb, self.__txmachung_int_raw_lsb)
    @txmachung_int_raw.setter
    def txmachung_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__txmachung_int_raw_msb, self.__txmachung_int_raw_lsb, value)
...
class INT1_ST_MAC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__txmachung_int_st_lsb = 10
        self.__txmachung_int_st_msb = 10
    ...
    @property
    def txmachung_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__txmachung_int_st_msb, self.__txmachung_int_st_lsb)
    @txmachung_int_st.setter
    def txmachung_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__txmachung_int_st_msb, self.__txmachung_int_st_lsb, value)
...
class INT1_CLR_MAC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__txmachung_int_clr_lsb = 10
        self.__txmachung_int_clr_msb = 10
    ...
    @property
    def txmachung_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__txmachung_int_clr_msb, self.__txmachung_int_clr_lsb)
    @txmachung_int_clr.setter
    def txmachung_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__txmachung_int_clr_msb, self.__txmachung_int_clr_lsb, value)
...
class INT_NMI_MAC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__rxmachung_int_nmi_lsb = 25
        self.__rxmachung_int_nmi_msb = 25
        ...
        self.__rxcomplete_int_nmi_lsb = 14
        self.__rxcomplete_int_nmi_msb = 14
    ...
    @property
    def rxmachung_int_nmi(self):
        return self.__MEM.rdm(self.__addr, self.__rxmachung_int_nmi_msb, self.__rxmachung_int_nmi_lsb)
    @rxmachung_int_nmi.setter
    def rxmachung_int_nmi(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxmachung_int_nmi_msb, self.__rxmachung_int_nmi_lsb, value)
    ...
    @property
    def rxcomplete_int_nmi(self):
        return self.__MEM.rdm(self.__addr, self.__rxcomplete_int_nmi_msb, self.__rxcomplete_int_nmi_lsb)
    @rxcomplete_int_nmi.setter
    def rxcomplete_int_nmi(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxcomplete_int_nmi_msb, self.__rxcomplete_int_nmi_lsb, value)
...
class INT_ENA_MAC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__rxmachung_int_ena_lsb = 25
        self.__rxmachung_int_ena_msb = 25
        ...
        self.__rxcomplete_int_ena_lsb = 14
        self.__rxcomplete_int_ena_msb = 14
    ...
    @property
    def rxmachung_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__rxmachung_int_ena_msb, self.__rxmachung_int_ena_lsb)
    @rxmachung_int_ena.setter
    def rxmachung_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxmachung_int_ena_msb, self.__rxmachung_int_ena_lsb, value)
    ...
    @property
    def rxcomplete_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__rxcomplete_int_ena_msb, self.__rxcomplete_int_ena_lsb)
    @rxcomplete_int_ena.setter
    def rxcomplete_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxcomplete_int_ena_msb, self.__rxcomplete_int_ena_lsb, value)
...
class INT_RAW_MAC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__rxmachung_int_raw_lsb = 25
        self.__rxmachung_int_raw_msb = 25
        ...
        self.__rxcomplete_int_raw_lsb = 14
        self.__rxcomplete_int_raw_msb = 14
    ...
    @property
    def rxmachung_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__rxmachung_int_raw_msb, self.__rxmachung_int_raw_lsb)
    @rxmachung_int_raw.setter
    def rxmachung_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxmachung_int_raw_msb, self.__rxmachung_int_raw_lsb, value)
    ...
    @property
    def rxcomplete_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__rxcomplete_int_raw_msb, self.__rxcomplete_int_raw_lsb)
    @rxcomplete_int_raw.setter
    def rxcomplete_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxcomplete_int_raw_msb, self.__rxcomplete_int_raw_lsb, value)
...
class INT_ST_MAC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__rxmachung_int_st_lsb = 25
        self.__rxmachung_int_st_msb = 25
        ...
        self.__rxcomplete_int_st_lsb = 14
        self.__rxcomplete_int_st_msb = 14
    ...
    @property
    def rxmachung_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__rxmachung_int_st_msb, self.__rxmachung_int_st_lsb)
    @rxmachung_int_st.setter
    def rxmachung_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxmachung_int_st_msb, self.__rxmachung_int_st_lsb, value)
    ...
    @property
    def rxcomplete_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__rxcomplete_int_st_msb, self.__rxcomplete_int_st_lsb)
    @rxcomplete_int_st.setter
    def rxcomplete_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxcomplete_int_st_msb, self.__rxcomplete_int_st_lsb, value)
...
class INT_CLR_MAC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__rxmachung_int_clr_lsb = 25
        self.__rxmachung_int_clr_msb = 25
        ...
        self.__rxcomplete_int_clr_lsb = 14
        self.__rxcomplete_int_clr_msb = 14
    ...
    @property
    def rxmachung_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__rxmachung_int_clr_msb, self.__rxmachung_int_clr_lsb)
    @rxmachung_int_clr.setter
    def rxmachung_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxmachung_int_clr_msb, self.__rxmachung_int_clr_lsb, value)
    ...
    @property
    def rxcomplete_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__rxcomplete_int_clr_msb, self.__rxcomplete_int_clr_lsb)
    @rxcomplete_int_clr.setter
    def rxcomplete_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxcomplete_int_clr_msb, self.__rxcomplete_int_clr_lsb, value)
...
class MACDELAY1(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x48
        self.__reg_mbusy_delay_lsb = 0
        self.__reg_mbusy_delay_msb = 7
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_mbusy_delay(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mbusy_delay_msb, self.__reg_mbusy_delay_lsb)
    @reg_mbusy_delay.setter
    def reg_mbusy_delay(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mbusy_delay_msb, self.__reg_mbusy_delay_lsb, value)
...
class MACAHBRG_HI(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x5c
        self.__reg_ahb_rg_hi_lsb = 0
        self.__reg_ahb_rg_hi_msb = 19
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_ahb_rg_hi(self):
        return self.__MEM.rdm(self.__addr, self.__reg_ahb_rg_hi_msb, self.__reg_ahb_rg_hi_lsb)
    @reg_ahb_rg_hi.setter
    def reg_ahb_rg_hi(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_ahb_rg_hi_msb, self.__reg_ahb_rg_hi_lsb, value)
class MACAHBRG_LO(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x60
        self.__reg_ahb_rg_lo_lsb = 0
        self.__reg_ahb_rg_lo_msb = 19
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_ahb_rg_lo(self):
        return self.__MEM.rdm(self.__addr, self.__reg_ahb_rg_lo_msb, self.__reg_ahb_rg_lo_lsb)
    @reg_ahb_rg_lo.setter
    def reg_ahb_rg_lo(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_ahb_rg_lo_msb, self.__reg_ahb_rg_lo_lsb, value)
class MACAHBMTEST(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_ahb_addr_prefix_lsb = 20
        self.__reg_ahb_addr_prefix_msb = 31
    ...
    @property
    def reg_ahb_addr_prefix(self):
        return self.__MEM.rdm(self.__addr, self.__reg_ahb_addr_prefix_msb, self.__reg_ahb_addr_prefix_lsb)
    @reg_ahb_addr_prefix.setter
    def reg_ahb_addr_prefix(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_ahb_addr_prefix_msb, self.__reg_ahb_addr_prefix_lsb, value)
...
class MACOPTIONS(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txbbstop_delay_lsb = 19
        self.__reg_txbbstop_delay_msb = 22
        self.__reg_rxstart_bea_use_bb_lsb = 18
        self.__reg_rxstart_bea_use_bb_msb = 18
        ...
        self.__reg_txht80_multilen_lsb = 12
        self.__reg_txht80_multilen_msb = 12
    ...
    @property
    def reg_txbbstop_delay(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txbbstop_delay_msb, self.__reg_txbbstop_delay_lsb)
    @reg_txbbstop_delay.setter
    def reg_txbbstop_delay(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txbbstop_delay_msb, self.__reg_txbbstop_delay_lsb, value)

    @property
    def reg_rxstart_bea_use_bb(self):
        return self.__MEM.rdm(self.__addr, self.__reg_rxstart_bea_use_bb_msb, self.__reg_rxstart_bea_use_bb_lsb)
    @reg_rxstart_bea_use_bb.setter
    def reg_rxstart_bea_use_bb(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_rxstart_bea_use_bb_msb, self.__reg_rxstart_bea_use_bb_lsb, value)
    ...
    @property
    def reg_txht80_multilen(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txht80_multilen_msb, self.__reg_txht80_multilen_lsb)
    @reg_txht80_multilen.setter
    def reg_txht80_multilen(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txht80_multilen_msb, self.__reg_txht80_multilen_lsb, value)
...
class MACSECOND_CCACONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_autorxtxcts_care_curseccca_lsb = 31
        self.__reg_autorxtxcts_care_curseccca_msb = 31
        self.__reg_autorxtxcts_care_curseccca40_lsb = 30
        self.__reg_autorxtxcts_care_curseccca40_msb = 30
        self.__reg_autotxdata_care_rxcts_lsb = 29
        self.__reg_autotxdata_care_rxcts_msb = 29
        self.__reg_autotxdata_care_rxcts40_lsb = 28
        self.__reg_autotxdata_care_rxcts40_msb = 28
        self.__reg_autotxdata_care_curseccca_lsb = 27
        self.__reg_autotxdata_care_curseccca_msb = 27
        self.__reg_autotxdata_care_curseccca40_lsb = 26
        self.__reg_autotxdata_care_curseccca40_msb = 26
        self.__reg_secondcca40_count_lsb = 8
        self.__reg_secondcca40_count_msb = 15
    ...
    @property
    def reg_autorxtxcts_care_curseccca40(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autorxtxcts_care_curseccca40_msb, self.__reg_autorxtxcts_care_curseccca40_lsb)
    @reg_autorxtxcts_care_curseccca40.setter
    def reg_autorxtxcts_care_curseccca40(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autorxtxcts_care_curseccca40_msb, self.__reg_autorxtxcts_care_curseccca40_lsb, value)

    @property
    def reg_autotxdata_care_rxcts(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autotxdata_care_rxcts_msb, self.__reg_autotxdata_care_rxcts_lsb)
    @reg_autotxdata_care_rxcts.setter
    def reg_autotxdata_care_rxcts(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autotxdata_care_rxcts_msb, self.__reg_autotxdata_care_rxcts_lsb, value)

    @property
    def reg_autotxdata_care_rxcts40(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autotxdata_care_rxcts40_msb, self.__reg_autotxdata_care_rxcts40_lsb)
    @reg_autotxdata_care_rxcts40.setter
    def reg_autotxdata_care_rxcts40(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autotxdata_care_rxcts40_msb, self.__reg_autotxdata_care_rxcts40_lsb, value)

    @property
    def reg_autotxdata_care_curseccca(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autotxdata_care_curseccca_msb, self.__reg_autotxdata_care_curseccca_lsb)
    @reg_autotxdata_care_curseccca.setter
    def reg_autotxdata_care_curseccca(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autotxdata_care_curseccca_msb, self.__reg_autotxdata_care_curseccca_lsb, value)

    @property
    def reg_autotxdata_care_curseccca40(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autotxdata_care_curseccca40_msb, self.__reg_autotxdata_care_curseccca40_lsb)
    @reg_autotxdata_care_curseccca40.setter
    def reg_autotxdata_care_curseccca40(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autotxdata_care_curseccca40_msb, self.__reg_autotxdata_care_curseccca40_lsb, value)

    @property
    def reg_secondcca40_count(self):
        return self.__MEM.rdm(self.__addr, self.__reg_secondcca40_count_msb, self.__reg_secondcca40_count_lsb)
    @reg_secondcca40_count.setter
    def reg_secondcca40_count(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_secondcca40_count_msb, self.__reg_secondcca40_count_lsb, value)
...
class MACRXTXOPTION(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_coex_errcode_opt_lsb = 4
        self.__reg_coex_errcode_opt_msb = 4
    ...
    @property
    def reg_coex_errcode_opt(self):
        return self.__MEM.rdm(self.__addr, self.__reg_coex_errcode_opt_msb, self.__reg_coex_errcode_opt_lsb)
    @reg_coex_errcode_opt.setter
    def reg_coex_errcode_opt(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_coex_errcode_opt_msb, self.__reg_coex_errcode_opt_lsb, value)
...
class MACTXIMR2_CONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_tximr2_ena_pti_lsb = 28
        self.__reg_tximr2_ena_pti_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_tximr2_ena_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_tximr2_ena_pti_msb, self.__reg_tximr2_ena_pti_lsb)
    @reg_tximr2_ena_pti.setter
    def reg_tximr2_ena_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_tximr2_ena_pti_msb, self.__reg_tximr2_ena_pti_lsb, value)
class MACTXIMR2_PLCP0(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_tximr2_txop_lg_lsb = 29
        self.__reg_tximr2_txop_lg_msb = 29
    ...
    @property
    def reg_tximr2_txop_lg(self):
        return self.__MEM.rdm(self.__addr, self.__reg_tximr2_txop_lg_msb, self.__reg_tximr2_txop_lg_lsb)
    @reg_tximr2_txop_lg.setter
    def reg_tximr2_txop_lg(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_tximr2_txop_lg_msb, self.__reg_tximr2_txop_lg_lsb, value)
...
class MACTXIMR1_CONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_tximr1_ena_pti_lsb = 28
        self.__reg_tximr1_ena_pti_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_tximr1_ena_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_tximr1_ena_pti_msb, self.__reg_tximr1_ena_pti_lsb)
    @reg_tximr1_ena_pti.setter
    def reg_tximr1_ena_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_tximr1_ena_pti_msb, self.__reg_tximr1_ena_pti_lsb, value)
class MACTXIMR1_PLCP0(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_tximr1_txop_lg_lsb = 29
        self.__reg_tximr1_txop_lg_msb = 29
    ...
    @property
    def reg_tximr1_txop_lg(self):
        return self.__MEM.rdm(self.__addr, self.__reg_tximr1_txop_lg_msb, self.__reg_tximr1_txop_lg_lsb)
    @reg_tximr1_txop_lg.setter
    def reg_tximr1_txop_lg(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_tximr1_txop_lg_msb, self.__reg_tximr1_txop_lg_lsb, value)
...
class MACTXIMR0_CONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_tximr0_ena_pti_lsb = 28
        self.__reg_tximr0_ena_pti_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_tximr0_ena_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_tximr0_ena_pti_msb, self.__reg_tximr0_ena_pti_lsb)
    @reg_tximr0_ena_pti.setter
    def reg_tximr0_ena_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_tximr0_ena_pti_msb, self.__reg_tximr0_ena_pti_lsb, value)
class MACTXIMR0_PLCP0(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_tximr0_txop_lg_lsb = 29
        self.__reg_tximr0_txop_lg_msb = 29
    ...
    @property
    def reg_tximr0_txop_lg(self):
        return self.__MEM.rdm(self.__addr, self.__reg_tximr0_txop_lg_msb, self.__reg_tximr0_txop_lg_lsb)
    @reg_tximr0_txop_lg.setter
    def reg_tximr0_txop_lg(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_tximr0_txop_lg_msb, self.__reg_tximr0_txop_lg_lsb, value)
...
class MACTXQ7_CONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq7_ena_pti_lsb = 28
        self.__reg_txq7_ena_pti_msb = 31
    ...
    @property
    def reg_txq7_ena_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq7_ena_pti_msb, self.__reg_txq7_ena_pti_lsb)
    @reg_txq7_ena_pti.setter
    def reg_txq7_ena_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq7_ena_pti_msb, self.__reg_txq7_ena_pti_lsb, value)
...
class MACTXQ7_PLCP0(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq7_txop_lg_lsb = 29
        self.__reg_txq7_txop_lg_msb = 29
    ...
    @property
    def reg_txq7_txop_lg(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq7_txop_lg_msb, self.__reg_txq7_txop_lg_lsb)
    @reg_txq7_txop_lg.setter
    def reg_txq7_txop_lg(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq7_txop_lg_msb, self.__reg_txq7_txop_lg_lsb, value)
...
class MACTXQ6_CONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq6_ena_pti_lsb = 28
        self.__reg_txq6_ena_pti_msb = 31
    ...
    @property
    def reg_txq6_ena_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq6_ena_pti_msb, self.__reg_txq6_ena_pti_lsb)
    @reg_txq6_ena_pti.setter
    def reg_txq6_ena_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq6_ena_pti_msb, self.__reg_txq6_ena_pti_lsb, value)
...
class MACTXQ6_PLCP0(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq6_txop_lg_lsb = 29
        self.__reg_txq6_txop_lg_msb = 29
    ...
    @property
    def reg_txq6_txop_lg(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq6_txop_lg_msb, self.__reg_txq6_txop_lg_lsb)
    @reg_txq6_txop_lg.setter
    def reg_txq6_txop_lg(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq6_txop_lg_msb, self.__reg_txq6_txop_lg_lsb, value)
...
class MACTXQ5_CONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq5_ena_pti_lsb = 28
        self.__reg_txq5_ena_pti_msb = 31
    ...
    @property
    def reg_txq5_ena_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq5_ena_pti_msb, self.__reg_txq5_ena_pti_lsb)
    @reg_txq5_ena_pti.setter
    def reg_txq5_ena_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq5_ena_pti_msb, self.__reg_txq5_ena_pti_lsb, value)
...
class MACTXQ5_PLCP0(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq5_txop_lg_lsb = 29
        self.__reg_txq5_txop_lg_msb = 29
    ...
    @property
    def reg_txq5_txop_lg(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq5_txop_lg_msb, self.__reg_txq5_txop_lg_lsb)
    @reg_txq5_txop_lg.setter
    def reg_txq5_txop_lg(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq5_txop_lg_msb, self.__reg_txq5_txop_lg_lsb, value)
...
class MACTXQ4_CONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq4_ena_pti_lsb = 28
        self.__reg_txq4_ena_pti_msb = 31
    ...
    @property
    def reg_txq4_ena_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq4_ena_pti_msb, self.__reg_txq4_ena_pti_lsb)
    @reg_txq4_ena_pti.setter
    def reg_txq4_ena_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq4_ena_pti_msb, self.__reg_txq4_ena_pti_lsb, value)
...
class MACTXQ4_PLCP0(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq4_txop_lg_lsb = 29
        self.__reg_txq4_txop_lg_msb = 29
    ...
    @property
    def reg_txq4_txop_lg(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq4_txop_lg_msb, self.__reg_txq4_txop_lg_lsb)
    @reg_txq4_txop_lg.setter
    def reg_txq4_txop_lg(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq4_txop_lg_msb, self.__reg_txq4_txop_lg_lsb, value)
...
class MACTXQ3_CONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq3_ena_pti_lsb = 28
        self.__reg_txq3_ena_pti_msb = 31
    ...
    @property
    def reg_txq3_ena_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq3_ena_pti_msb, self.__reg_txq3_ena_pti_lsb)
    @reg_txq3_ena_pti.setter
    def reg_txq3_ena_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq3_ena_pti_msb, self.__reg_txq3_ena_pti_lsb, value)
...
class MACTXQ3_PLCP0(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq3_txop_lg_lsb = 29
        self.__reg_txq3_txop_lg_msb = 29
    ...
    @property
    def reg_txq3_txop_lg(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq3_txop_lg_msb, self.__reg_txq3_txop_lg_lsb)
    @reg_txq3_txop_lg.setter
    def reg_txq3_txop_lg(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq3_txop_lg_msb, self.__reg_txq3_txop_lg_lsb, value)
...
class MACTXQ2_CONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq2_ena_pti_lsb = 28
        self.__reg_txq2_ena_pti_msb = 31
    ...
    @property
    def reg_txq2_ena_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq2_ena_pti_msb, self.__reg_txq2_ena_pti_lsb)
    @reg_txq2_ena_pti.setter
    def reg_txq2_ena_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq2_ena_pti_msb, self.__reg_txq2_ena_pti_lsb, value)
...
class MACTXQ2_PLCP0(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq2_txop_lg_lsb = 29
        self.__reg_txq2_txop_lg_msb = 29
    ...
    @property
    def reg_txq2_txop_lg(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq2_txop_lg_msb, self.__reg_txq2_txop_lg_lsb)
    @reg_txq2_txop_lg.setter
    def reg_txq2_txop_lg(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq2_txop_lg_msb, self.__reg_txq2_txop_lg_lsb, value)
...
class MACTXQ1_CONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq1_ena_pti_lsb = 28
        self.__reg_txq1_ena_pti_msb = 31
    ...
    @property
    def reg_txq1_ena_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq1_ena_pti_msb, self.__reg_txq1_ena_pti_lsb)
    @reg_txq1_ena_pti.setter
    def reg_txq1_ena_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq1_ena_pti_msb, self.__reg_txq1_ena_pti_lsb, value)
...
class MACTXQ1_PLCP0(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq1_txop_lg_lsb = 29
        self.__reg_txq1_txop_lg_msb = 29
    ...
    @property
    def reg_txq1_txop_lg(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq1_txop_lg_msb, self.__reg_txq1_txop_lg_lsb)
    @reg_txq1_txop_lg.setter
    def reg_txq1_txop_lg(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq1_txop_lg_msb, self.__reg_txq1_txop_lg_lsb, value)
...
class MACTXQ0_CONF(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq0_ena_pti_lsb = 28
        self.__reg_txq0_ena_pti_msb = 31
    ...
    @property
    def reg_txq0_ena_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq0_ena_pti_msb, self.__reg_txq0_ena_pti_lsb)
    @reg_txq0_ena_pti.setter
    def reg_txq0_ena_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq0_ena_pti_msb, self.__reg_txq0_ena_pti_lsb, value)
...
class MACTXQ0_PLCP0(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.__reg_txq0_txop_lg_lsb = 29
        self.__reg_txq0_txop_lg_msb = 29
    ...
    @property
    def reg_txq0_txop_lg(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq0_txop_lg_msb, self.__reg_txq0_txop_lg_lsb)
    @reg_txq0_txop_lg.setter
    def reg_txq0_txop_lg(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq0_txop_lg_msb, self.__reg_txq0_txop_lg_lsb, value)
...
class MACTXQ_MAINTAIN_CLR(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x10c
        self.__reg_txq7_maintain_clr_lsb = 7
        self.__reg_txq7_maintain_clr_msb = 7
        self.__reg_txq6_maintain_clr_lsb = 6
        self.__reg_txq6_maintain_clr_msb = 6
        self.__reg_txq5_maintain_clr_lsb = 5
        self.__reg_txq5_maintain_clr_msb = 5
        self.__reg_txq4_maintain_clr_lsb = 4
        self.__reg_txq4_maintain_clr_msb = 4
        self.__reg_txq3_maintain_clr_lsb = 3
        self.__reg_txq3_maintain_clr_msb = 3
        self.__reg_txq2_maintain_clr_lsb = 2
        self.__reg_txq2_maintain_clr_msb = 2
        self.__reg_txq1_maintain_clr_lsb = 1
        self.__reg_txq1_maintain_clr_msb = 1
        self.__reg_txq0_maintain_clr_lsb = 0
        self.__reg_txq0_maintain_clr_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_txq7_maintain_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq7_maintain_clr_msb, self.__reg_txq7_maintain_clr_lsb)
    @reg_txq7_maintain_clr.setter
    def reg_txq7_maintain_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq7_maintain_clr_msb, self.__reg_txq7_maintain_clr_lsb, value)

    @property
    def reg_txq6_maintain_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq6_maintain_clr_msb, self.__reg_txq6_maintain_clr_lsb)
    @reg_txq6_maintain_clr.setter
    def reg_txq6_maintain_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq6_maintain_clr_msb, self.__reg_txq6_maintain_clr_lsb, value)

    @property
    def reg_txq5_maintain_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq5_maintain_clr_msb, self.__reg_txq5_maintain_clr_lsb)
    @reg_txq5_maintain_clr.setter
    def reg_txq5_maintain_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq5_maintain_clr_msb, self.__reg_txq5_maintain_clr_lsb, value)

    @property
    def reg_txq4_maintain_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq4_maintain_clr_msb, self.__reg_txq4_maintain_clr_lsb)
    @reg_txq4_maintain_clr.setter
    def reg_txq4_maintain_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq4_maintain_clr_msb, self.__reg_txq4_maintain_clr_lsb, value)

    @property
    def reg_txq3_maintain_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq3_maintain_clr_msb, self.__reg_txq3_maintain_clr_lsb)
    @reg_txq3_maintain_clr.setter
    def reg_txq3_maintain_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq3_maintain_clr_msb, self.__reg_txq3_maintain_clr_lsb, value)

    @property
    def reg_txq2_maintain_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq2_maintain_clr_msb, self.__reg_txq2_maintain_clr_lsb)
    @reg_txq2_maintain_clr.setter
    def reg_txq2_maintain_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq2_maintain_clr_msb, self.__reg_txq2_maintain_clr_lsb, value)

    @property
    def reg_txq1_maintain_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq1_maintain_clr_msb, self.__reg_txq1_maintain_clr_lsb)
    @reg_txq1_maintain_clr.setter
    def reg_txq1_maintain_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq1_maintain_clr_msb, self.__reg_txq1_maintain_clr_lsb, value)

    @property
    def reg_txq0_maintain_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_txq0_maintain_clr_msb, self.__reg_txq0_maintain_clr_lsb)
    @reg_txq0_maintain_clr.setter
    def reg_txq0_maintain_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_txq0_maintain_clr_msb, self.__reg_txq0_maintain_clr_lsb, value)
...
class MACTXEND_TIME(object):
    def __init__(self, channel, chipv = "FPGA724"):
        ...
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1b0
...
class MACAUTOACK_TIME_VALID_CLR(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1b4
        self.__reg_autoack_time5_clr_lsb = 5
        self.__reg_autoack_time5_clr_msb = 5
        self.__reg_autoack_time4_clr_lsb = 4
        self.__reg_autoack_time4_clr_msb = 4
        self.__reg_autoack_time3_clr_lsb = 3
        self.__reg_autoack_time3_clr_msb = 3
        self.__reg_autoack_time2_clr_lsb = 2
        self.__reg_autoack_time2_clr_msb = 2
        self.__reg_autoack_time1_clr_lsb = 1
        self.__reg_autoack_time1_clr_msb = 1
        self.__reg_autoack_time0_clr_lsb = 0
        self.__reg_autoack_time0_clr_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_autoack_time5_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time5_clr_msb, self.__reg_autoack_time5_clr_lsb)
    @reg_autoack_time5_clr.setter
    def reg_autoack_time5_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time5_clr_msb, self.__reg_autoack_time5_clr_lsb, value)

    @property
    def reg_autoack_time4_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time4_clr_msb, self.__reg_autoack_time4_clr_lsb)
    @reg_autoack_time4_clr.setter
    def reg_autoack_time4_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time4_clr_msb, self.__reg_autoack_time4_clr_lsb, value)

    @property
    def reg_autoack_time3_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time3_clr_msb, self.__reg_autoack_time3_clr_lsb)
    @reg_autoack_time3_clr.setter
    def reg_autoack_time3_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time3_clr_msb, self.__reg_autoack_time3_clr_lsb, value)

    @property
    def reg_autoack_time2_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time2_clr_msb, self.__reg_autoack_time2_clr_lsb)
    @reg_autoack_time2_clr.setter
    def reg_autoack_time2_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time2_clr_msb, self.__reg_autoack_time2_clr_lsb, value)

    @property
    def reg_autoack_time1_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time1_clr_msb, self.__reg_autoack_time1_clr_lsb)
    @reg_autoack_time1_clr.setter
    def reg_autoack_time1_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time1_clr_msb, self.__reg_autoack_time1_clr_lsb, value)

    @property
    def reg_autoack_time0_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time0_clr_msb, self.__reg_autoack_time0_clr_lsb)
    @reg_autoack_time0_clr.setter
    def reg_autoack_time0_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time0_clr_msb, self.__reg_autoack_time0_clr_lsb, value)
class MACAUTOACK_TIME_VALID(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1b8
        self.__reg_autoack_time5_valid_lsb = 5
        self.__reg_autoack_time5_valid_msb = 5
        self.__reg_autoack_time4_valid_lsb = 4
        self.__reg_autoack_time4_valid_msb = 4
        self.__reg_autoack_time3_valid_lsb = 3
        self.__reg_autoack_time3_valid_msb = 3
        self.__reg_autoack_time2_valid_lsb = 2
        self.__reg_autoack_time2_valid_msb = 2
        self.__reg_autoack_time1_valid_lsb = 1
        self.__reg_autoack_time1_valid_msb = 1
        self.__reg_autoack_time0_valid_lsb = 0
        self.__reg_autoack_time0_valid_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_autoack_time5_valid(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time5_valid_msb, self.__reg_autoack_time5_valid_lsb)
    @reg_autoack_time5_valid.setter
    def reg_autoack_time5_valid(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time5_valid_msb, self.__reg_autoack_time5_valid_lsb, value)

    @property
    def reg_autoack_time4_valid(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time4_valid_msb, self.__reg_autoack_time4_valid_lsb)
    @reg_autoack_time4_valid.setter
    def reg_autoack_time4_valid(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time4_valid_msb, self.__reg_autoack_time4_valid_lsb, value)

    @property
    def reg_autoack_time3_valid(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time3_valid_msb, self.__reg_autoack_time3_valid_lsb)
    @reg_autoack_time3_valid.setter
    def reg_autoack_time3_valid(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time3_valid_msb, self.__reg_autoack_time3_valid_lsb, value)

    @property
    def reg_autoack_time2_valid(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time2_valid_msb, self.__reg_autoack_time2_valid_lsb)
    @reg_autoack_time2_valid.setter
    def reg_autoack_time2_valid(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time2_valid_msb, self.__reg_autoack_time2_valid_lsb, value)

    @property
    def reg_autoack_time1_valid(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time1_valid_msb, self.__reg_autoack_time1_valid_lsb)
    @reg_autoack_time1_valid.setter
    def reg_autoack_time1_valid(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time1_valid_msb, self.__reg_autoack_time1_valid_lsb, value)

    @property
    def reg_autoack_time0_valid(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_time0_valid_msb, self.__reg_autoack_time0_valid_lsb)
    @reg_autoack_time0_valid.setter
    def reg_autoack_time0_valid(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_time0_valid_msb, self.__reg_autoack_time0_valid_lsb, value)
class MACAUTOACK_TIMER0_US(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1bc
        self.__autoack0_timer_us_lsb = 0
        self.__autoack0_timer_us_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack0_timer_us(self):
        return self.__MEM.rdm(self.__addr, self.__autoack0_timer_us_msb, self.__autoack0_timer_us_lsb)
    @autoack0_timer_us.setter
    def autoack0_timer_us(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack0_timer_us_msb, self.__autoack0_timer_us_lsb, value)
class MACAUTOACK_TIMER0_CYC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1c0
        self.__autoack0_timer_cyc_lsb = 0
        self.__autoack0_timer_cyc_msb = 6
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack0_timer_cyc(self):
        return self.__MEM.rdm(self.__addr, self.__autoack0_timer_cyc_msb, self.__autoack0_timer_cyc_lsb)
    @autoack0_timer_cyc.setter
    def autoack0_timer_cyc(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack0_timer_cyc_msb, self.__autoack0_timer_cyc_lsb, value)
class MACAUTOACK_TIMER1_US(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1c4
        self.__autoack1_timer_us_lsb = 0
        self.__autoack1_timer_us_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack1_timer_us(self):
        return self.__MEM.rdm(self.__addr, self.__autoack1_timer_us_msb, self.__autoack1_timer_us_lsb)
    @autoack1_timer_us.setter
    def autoack1_timer_us(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack1_timer_us_msb, self.__autoack1_timer_us_lsb, value)
class MACAUTOACK_TIMER1_CYC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1c8
        self.__autoack1_timer_cyc_lsb = 0
        self.__autoack1_timer_cyc_msb = 6
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack1_timer_cyc(self):
        return self.__MEM.rdm(self.__addr, self.__autoack1_timer_cyc_msb, self.__autoack1_timer_cyc_lsb)
    @autoack1_timer_cyc.setter
    def autoack1_timer_cyc(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack1_timer_cyc_msb, self.__autoack1_timer_cyc_lsb, value)
class MACAUTOACK_TIMER2_US(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1cc
        self.__autoack2_timer_us_lsb = 0
        self.__autoack2_timer_us_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack2_timer_us(self):
        return self.__MEM.rdm(self.__addr, self.__autoack2_timer_us_msb, self.__autoack2_timer_us_lsb)
    @autoack2_timer_us.setter
    def autoack2_timer_us(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack2_timer_us_msb, self.__autoack2_timer_us_lsb, value)
class MACAUTOACK_TIMER2_CYC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1d0
        self.__autoack2_timer_cyc_lsb = 0
        self.__autoack2_timer_cyc_msb = 6
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack2_timer_cyc(self):
        return self.__MEM.rdm(self.__addr, self.__autoack2_timer_cyc_msb, self.__autoack2_timer_cyc_lsb)
    @autoack2_timer_cyc.setter
    def autoack2_timer_cyc(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack2_timer_cyc_msb, self.__autoack2_timer_cyc_lsb, value)
class MACAUTOACK_TIMER3_US(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1d4
        self.__autoack3_timer_us_lsb = 0
        self.__autoack3_timer_us_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack3_timer_us(self):
        return self.__MEM.rdm(self.__addr, self.__autoack3_timer_us_msb, self.__autoack3_timer_us_lsb)
    @autoack3_timer_us.setter
    def autoack3_timer_us(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack3_timer_us_msb, self.__autoack3_timer_us_lsb, value)
class MACAUTOACK_TIMER3_CYC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1d8
        self.__autoack3_timer_cyc_lsb = 0
        self.__autoack3_timer_cyc_msb = 6
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack3_timer_cyc(self):
        return self.__MEM.rdm(self.__addr, self.__autoack3_timer_cyc_msb, self.__autoack3_timer_cyc_lsb)
    @autoack3_timer_cyc.setter
    def autoack3_timer_cyc(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack3_timer_cyc_msb, self.__autoack3_timer_cyc_lsb, value)
class MACAUTOACK_TIMER4_US(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1dc
        self.__autoack4_timer_us_lsb = 0
        self.__autoack4_timer_us_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack4_timer_us(self):
        return self.__MEM.rdm(self.__addr, self.__autoack4_timer_us_msb, self.__autoack4_timer_us_lsb)
    @autoack4_timer_us.setter
    def autoack4_timer_us(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack4_timer_us_msb, self.__autoack4_timer_us_lsb, value)
class MACAUTOACK_TIMER4_CYC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1e0
        self.__autoack4_timer_cyc_lsb = 0
        self.__autoack4_timer_cyc_msb = 6
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack4_timer_cyc(self):
        return self.__MEM.rdm(self.__addr, self.__autoack4_timer_cyc_msb, self.__autoack4_timer_cyc_lsb)
    @autoack4_timer_cyc.setter
    def autoack4_timer_cyc(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack4_timer_cyc_msb, self.__autoack4_timer_cyc_lsb, value)
class MACAUTOACK_TIMER5_US(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1e4
        self.__autoack5_timer_us_lsb = 0
        self.__autoack5_timer_us_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack5_timer_us(self):
        return self.__MEM.rdm(self.__addr, self.__autoack5_timer_us_msb, self.__autoack5_timer_us_lsb)
    @autoack5_timer_us.setter
    def autoack5_timer_us(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack5_timer_us_msb, self.__autoack5_timer_us_lsb, value)
class MACAUTOACK_TIMER5_CYC(object):
    def __init__(self, channel, chipv = "FPGA724"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1e8
        self.__autoack5_timer_cyc_lsb = 0
        self.__autoack5_timer_cyc_msb = 6
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def autoack5_timer_cyc(self):
        return self.__MEM.rdm(self.__addr, self.__autoack5_timer_cyc_msb, self.__autoack5_timer_cyc_lsb)
    @autoack5_timer_cyc.setter
    def autoack5_timer_cyc(self, value):
        return self.__MEM.wrm(self.__addr, self.__autoack5_timer_cyc_msb, self.__autoack5_timer_cyc_lsb, value)
