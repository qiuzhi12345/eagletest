...
class AGCGAIN_CTRL_1(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.__reg_bk2sch_reset_rfagc_en_lsb = 31
        self.__reg_bk2sch_reset_rfagc_en_msb = 31
        self.__reg_reset_rfgain_cnt_en_lsb = 30
        self.__reg_reset_rfgain_cnt_en_msb = 30
    ...
    @property
    def reg_bk2sch_reset_rfagc_en(self):
        return self.__MEM.rdm(self.__addr, self.__reg_bk2sch_reset_rfagc_en_msb, self.__reg_bk2sch_reset_rfagc_en_lsb)
    @reg_bk2sch_reset_rfagc_en.setter
    def reg_bk2sch_reset_rfagc_en(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_bk2sch_reset_rfagc_en_msb, self.__reg_bk2sch_reset_rfagc_en_lsb, value)

    @property
    def reg_reset_rfgain_cnt_en(self):
        return self.__MEM.rdm(self.__addr, self.__reg_reset_rfgain_cnt_en_msb, self.__reg_reset_rfgain_cnt_en_lsb)
    @reg_reset_rfgain_cnt_en.setter
    def reg_reset_rfgain_cnt_en(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_reset_rfgain_cnt_en_msb, self.__reg_reset_rfgain_cnt_en_lsb, value)
...
class AGCFSM_CTRL4(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.__reg_bt_dis_cca_lsb = 31
        self.__reg_bt_dis_cca_msb = 31
    ...
    @property
    def reg_bt_dis_cca(self):
        return self.__MEM.rdm(self.__addr, self.__reg_bt_dis_cca_msb, self.__reg_bt_dis_cca_lsb)
    @reg_bt_dis_cca.setter
    def reg_bt_dis_cca(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_bt_dis_cca_msb, self.__reg_bt_dis_cca_lsb, value)
...
class AGCPWR_CTRL12(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.__reg_stfpwr_restart_thr_lsb = 27
        self.__reg_stfpwr_restart_thr_msb = 31
    ...
    @property
    def reg_stfpwr_restart_thr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_stfpwr_restart_thr_msb, self.__reg_stfpwr_restart_thr_lsb)
    @reg_stfpwr_restart_thr.setter
    def reg_stfpwr_restart_thr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_stfpwr_restart_thr_msb, self.__reg_stfpwr_restart_thr_lsb, value)
...
class AGCPWR_CTRL22(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.__reg_rxfbw_comp_bt_lsb = 24
        self.__reg_rxfbw_comp_bt_msb = 28
        self.__reg_rxfbw_comp_wifi_1_lsb = 19
        self.__reg_rxfbw_comp_wifi_1_msb = 23
        self.__reg_rxfbw_comp_wifi_2_lsb = 14
        self.__reg_rxfbw_comp_wifi_2_msb = 18
        self.__reg_rc_filter_noise_en_lsb = 13
        self.__reg_rc_filter_noise_en_msb = 13
        self.__reg_load_noise_rc_init_lsb = 12
        self.__reg_load_noise_rc_init_msb = 12
    ...
    @property
    def reg_rxfbw_comp_bt(self):
        return self.__MEM.rdm(self.__addr, self.__reg_rxfbw_comp_bt_msb, self.__reg_rxfbw_comp_bt_lsb)
    @reg_rxfbw_comp_bt.setter
    def reg_rxfbw_comp_bt(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_rxfbw_comp_bt_msb, self.__reg_rxfbw_comp_bt_lsb, value)

    @property
    def reg_rxfbw_comp_wifi_1(self):
        return self.__MEM.rdm(self.__addr, self.__reg_rxfbw_comp_wifi_1_msb, self.__reg_rxfbw_comp_wifi_1_lsb)
    @reg_rxfbw_comp_wifi_1.setter
    def reg_rxfbw_comp_wifi_1(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_rxfbw_comp_wifi_1_msb, self.__reg_rxfbw_comp_wifi_1_lsb, value)

    @property
    def reg_rxfbw_comp_wifi_2(self):
        return self.__MEM.rdm(self.__addr, self.__reg_rxfbw_comp_wifi_2_msb, self.__reg_rxfbw_comp_wifi_2_lsb)
    @reg_rxfbw_comp_wifi_2.setter
    def reg_rxfbw_comp_wifi_2(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_rxfbw_comp_wifi_2_msb, self.__reg_rxfbw_comp_wifi_2_lsb, value)
...
class AGCPWR_CTRL25(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.__reg_11b_rssi_compen_lsb = 25
        self.__reg_11b_rssi_compen_msb = 29
    ...
    @property
    def reg_11b_rssi_compen(self):
        return self.__MEM.rdm(self.__addr, self.__reg_11b_rssi_compen_msb, self.__reg_11b_rssi_compen_lsb)
    @reg_11b_rssi_compen.setter
    def reg_11b_rssi_compen(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_11b_rssi_compen_msb, self.__reg_11b_rssi_compen_lsb, value)
