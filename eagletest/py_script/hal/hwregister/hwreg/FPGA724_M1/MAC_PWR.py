...
class MAC_PWR(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.MACTSF_OPTIONS = MACTSF_OPTIONS(self.channel, self.chipv)
        ...
        self.MACTSF_PTI_CLR = MACTSF_PTI_CLR(self.channel, self.chipv)
        self.MACTSF_PTI_MT_CNT = MACTSF_PTI_MT_CNT(self.channel, self.chipv)
        self.MACTSF_PTI_MT_CONF = MACTSF_PTI_MT_CONF(self.channel, self.chipv)
        self.MACTSF_PTI_CONF = MACTSF_PTI_CONF(self.channel, self.chipv)
        ...
        self.MAC_BACKUP_DMA_CONF = MAC_BACKUP_DMA_CONF(self.channel, self.chipv)
        self.MAC_BACKUP_DMA_ADDR = MAC_BACKUP_DMA_ADDR(self.channel, self.chipv)
        self.MAC_BACKUP_DMA_DEBUG = MAC_BACKUP_DMA_DEBUG(self.channel, self.chipv)
...
class MACTSF_OPTIONS(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_PWR_BASE + 0x10
        self.__reg_tsfbbtx_compen_lsb = 16
        self.__reg_tsfbbtx_compen_msb = 31
        self.__reg_tsfbbrx_compen_lsb = 0
        self.__reg_tsfbbrx_compen_msb = 15
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_tsfbbtx_compen(self):
        return self.__MEM.rdm(self.__addr, self.__reg_tsfbbtx_compen_msb, self.__reg_tsfbbtx_compen_lsb)
    @reg_tsfbbtx_compen.setter
    def reg_tsfbbtx_compen(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_tsfbbtx_compen_msb, self.__reg_tsfbbtx_compen_lsb, value)

    @property
    def reg_tsfbbrx_compen(self):
        return self.__MEM.rdm(self.__addr, self.__reg_tsfbbrx_compen_msb, self.__reg_tsfbbrx_compen_lsb)
    @reg_tsfbbrx_compen.setter
    def reg_tsfbbrx_compen(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_tsfbbrx_compen_msb, self.__reg_tsfbbrx_compen_lsb, value)
...
class MACTSF_PTI_CLR(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_PWR_BASE + 0x11c
        self.__reg_wlan_rxbeacon3_mt_clr_lsb = 3
        self.__reg_wlan_rxbeacon3_mt_clr_msb = 3
        self.__reg_wlan_rxbeacon2_mt_clr_lsb = 2
        self.__reg_wlan_rxbeacon2_mt_clr_msb = 2
        self.__reg_wlan_rxbeacon1_mt_clr_lsb = 1
        self.__reg_wlan_rxbeacon1_mt_clr_msb = 1
        self.__reg_wlan_rxbeacon0_mt_clr_lsb = 0
        self.__reg_wlan_rxbeacon0_mt_clr_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_wlan_rxbeacon3_mt_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon3_mt_clr_msb, self.__reg_wlan_rxbeacon3_mt_clr_lsb)
    @reg_wlan_rxbeacon3_mt_clr.setter
    def reg_wlan_rxbeacon3_mt_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon3_mt_clr_msb, self.__reg_wlan_rxbeacon3_mt_clr_lsb, value)

    @property
    def reg_wlan_rxbeacon2_mt_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon2_mt_clr_msb, self.__reg_wlan_rxbeacon2_mt_clr_lsb)
    @reg_wlan_rxbeacon2_mt_clr.setter
    def reg_wlan_rxbeacon2_mt_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon2_mt_clr_msb, self.__reg_wlan_rxbeacon2_mt_clr_lsb, value)

    @property
    def reg_wlan_rxbeacon1_mt_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon1_mt_clr_msb, self.__reg_wlan_rxbeacon1_mt_clr_lsb)
    @reg_wlan_rxbeacon1_mt_clr.setter
    def reg_wlan_rxbeacon1_mt_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon1_mt_clr_msb, self.__reg_wlan_rxbeacon1_mt_clr_lsb, value)

    @property
    def reg_wlan_rxbeacon0_mt_clr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon0_mt_clr_msb, self.__reg_wlan_rxbeacon0_mt_clr_lsb)
    @reg_wlan_rxbeacon0_mt_clr.setter
    def reg_wlan_rxbeacon0_mt_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon0_mt_clr_msb, self.__reg_wlan_rxbeacon0_mt_clr_lsb, value)
class MACTSF_PTI_MT_CNT(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_PWR_BASE + 0x120
        self.__reg_wlan_rxbeacon3_mt_cnt_lsb = 24
        self.__reg_wlan_rxbeacon3_mt_cnt_msb = 31
        self.__reg_wlan_rxbeacon2_mt_cnt_lsb = 16
        self.__reg_wlan_rxbeacon2_mt_cnt_msb = 23
        self.__reg_wlan_rxbeacon1_mt_cnt_lsb = 8
        self.__reg_wlan_rxbeacon1_mt_cnt_msb = 15
        self.__reg_wlan_rxbeacon0_mt_cnt_lsb = 0
        self.__reg_wlan_rxbeacon0_mt_cnt_msb = 7
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_wlan_rxbeacon3_mt_cnt(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon3_mt_cnt_msb, self.__reg_wlan_rxbeacon3_mt_cnt_lsb)
    @reg_wlan_rxbeacon3_mt_cnt.setter
    def reg_wlan_rxbeacon3_mt_cnt(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon3_mt_cnt_msb, self.__reg_wlan_rxbeacon3_mt_cnt_lsb, value)

    @property
    def reg_wlan_rxbeacon2_mt_cnt(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon2_mt_cnt_msb, self.__reg_wlan_rxbeacon2_mt_cnt_lsb)
    @reg_wlan_rxbeacon2_mt_cnt.setter
    def reg_wlan_rxbeacon2_mt_cnt(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon2_mt_cnt_msb, self.__reg_wlan_rxbeacon2_mt_cnt_lsb, value)

    @property
    def reg_wlan_rxbeacon1_mt_cnt(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon1_mt_cnt_msb, self.__reg_wlan_rxbeacon1_mt_cnt_lsb)
    @reg_wlan_rxbeacon1_mt_cnt.setter
    def reg_wlan_rxbeacon1_mt_cnt(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon1_mt_cnt_msb, self.__reg_wlan_rxbeacon1_mt_cnt_lsb, value)

    @property
    def reg_wlan_rxbeacon0_mt_cnt(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon0_mt_cnt_msb, self.__reg_wlan_rxbeacon0_mt_cnt_lsb)
    @reg_wlan_rxbeacon0_mt_cnt.setter
    def reg_wlan_rxbeacon0_mt_cnt(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon0_mt_cnt_msb, self.__reg_wlan_rxbeacon0_mt_cnt_lsb, value)
class MACTSF_PTI_MT_CONF(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_PWR_BASE + 0x124
        self.__reg_wlan_rxbeacon3_mt_pti_lsb = 12
        self.__reg_wlan_rxbeacon3_mt_pti_msb = 15
        self.__reg_wlan_rxbeacon2_mt_pti_lsb = 8
        self.__reg_wlan_rxbeacon2_mt_pti_msb = 11
        self.__reg_wlan_rxbeacon1_mt_pti_lsb = 4
        self.__reg_wlan_rxbeacon1_mt_pti_msb = 7
        self.__reg_wlan_rxbeacon0_mt_pti_lsb = 0
        self.__reg_wlan_rxbeacon0_mt_pti_msb = 3
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_wlan_rxbeacon3_mt_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon3_mt_pti_msb, self.__reg_wlan_rxbeacon3_mt_pti_lsb)
    @reg_wlan_rxbeacon3_mt_pti.setter
    def reg_wlan_rxbeacon3_mt_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon3_mt_pti_msb, self.__reg_wlan_rxbeacon3_mt_pti_lsb, value)

    @property
    def reg_wlan_rxbeacon2_mt_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon2_mt_pti_msb, self.__reg_wlan_rxbeacon2_mt_pti_lsb)
    @reg_wlan_rxbeacon2_mt_pti.setter
    def reg_wlan_rxbeacon2_mt_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon2_mt_pti_msb, self.__reg_wlan_rxbeacon2_mt_pti_lsb, value)

    @property
    def reg_wlan_rxbeacon1_mt_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon1_mt_pti_msb, self.__reg_wlan_rxbeacon1_mt_pti_lsb)
    @reg_wlan_rxbeacon1_mt_pti.setter
    def reg_wlan_rxbeacon1_mt_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon1_mt_pti_msb, self.__reg_wlan_rxbeacon1_mt_pti_lsb, value)

    @property
    def reg_wlan_rxbeacon0_mt_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_rxbeacon0_mt_pti_msb, self.__reg_wlan_rxbeacon0_mt_pti_lsb)
    @reg_wlan_rxbeacon0_mt_pti.setter
    def reg_wlan_rxbeacon0_mt_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_rxbeacon0_mt_pti_msb, self.__reg_wlan_rxbeacon0_mt_pti_lsb, value)
class MACTSF_PTI_CONF(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        ...
        self.__reg_wlan_default_pti_lsb = 8
        self.__reg_wlan_default_pti_msb = 11
        self.__reg_wlan_default_active_lsb = 4
        self.__reg_wlan_default_active_msb = 4
    ...
    @property
    def reg_wlan_default_pti(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_default_pti_msb, self.__reg_wlan_default_pti_lsb)
    @reg_wlan_default_pti.setter
    def reg_wlan_default_pti(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_default_pti_msb, self.__reg_wlan_default_pti_lsb, value)

    @property
    def reg_wlan_default_active(self):
        return self.__MEM.rdm(self.__addr, self.__reg_wlan_default_active_msb, self.__reg_wlan_default_active_lsb)
    @reg_wlan_default_active.setter
    def reg_wlan_default_active(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_wlan_default_active_msb, self.__reg_wlan_default_active_lsb, value)
...
class INT_ENA_MACPWR(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.__mac_backup_dma_done_int_ena_lsb = 13
        self.__mac_backup_dma_done_int_ena_msb = 13
        self.__rxbeacon3_maintain_reach_int_ena_lsb = 12
        self.__rxbeacon3_maintain_reach_int_ena_msb = 12
        self.__rxbeacon2_maintain_reach_int_ena_lsb = 11
        self.__rxbeacon2_maintain_reach_int_ena_msb = 11
        self.__rxbeacon1_maintain_reach_int_ena_lsb = 10
        self.__rxbeacon1_maintain_reach_int_ena_msb = 10
        self.__rxbeacon0_maintain_reach_int_ena_lsb = 9
        self.__rxbeacon0_maintain_reach_int_ena_msb = 9
    ...
    @property
    def mac_backup_dma_done_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__mac_backup_dma_done_int_ena_msb, self.__mac_backup_dma_done_int_ena_lsb)
    @mac_backup_dma_done_int_ena.setter
    def mac_backup_dma_done_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__mac_backup_dma_done_int_ena_msb, self.__mac_backup_dma_done_int_ena_lsb, value)

    @property
    def rxbeacon3_maintain_reach_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon3_maintain_reach_int_ena_msb, self.__rxbeacon3_maintain_reach_int_ena_lsb)
    @rxbeacon3_maintain_reach_int_ena.setter
    def rxbeacon3_maintain_reach_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon3_maintain_reach_int_ena_msb, self.__rxbeacon3_maintain_reach_int_ena_lsb, value)

    @property
    def rxbeacon2_maintain_reach_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon2_maintain_reach_int_ena_msb, self.__rxbeacon2_maintain_reach_int_ena_lsb)
    @rxbeacon2_maintain_reach_int_ena.setter
    def rxbeacon2_maintain_reach_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon2_maintain_reach_int_ena_msb, self.__rxbeacon2_maintain_reach_int_ena_lsb, value)

    @property
    def rxbeacon1_maintain_reach_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon1_maintain_reach_int_ena_msb, self.__rxbeacon1_maintain_reach_int_ena_lsb)
    @rxbeacon1_maintain_reach_int_ena.setter
    def rxbeacon1_maintain_reach_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon1_maintain_reach_int_ena_msb, self.__rxbeacon1_maintain_reach_int_ena_lsb, value)

    @property
    def rxbeacon0_maintain_reach_int_ena(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon0_maintain_reach_int_ena_msb, self.__rxbeacon0_maintain_reach_int_ena_lsb)
    @rxbeacon0_maintain_reach_int_ena.setter
    def rxbeacon0_maintain_reach_int_ena(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon0_maintain_reach_int_ena_msb, self.__rxbeacon0_maintain_reach_int_ena_lsb, value)
...
class INT_RAW_MACPWR(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.__mac_backup_dma_done_int_raw_lsb = 13
        self.__mac_backup_dma_done_int_raw_msb = 13
        self.__rxbeacon3_maintain_reach_int_raw_lsb = 12
        self.__rxbeacon3_maintain_reach_int_raw_msb = 12
        self.__rxbeacon2_maintain_reach_int_raw_lsb = 11
        self.__rxbeacon2_maintain_reach_int_raw_msb = 11
        self.__rxbeacon1_maintain_reach_int_raw_lsb = 10
        self.__rxbeacon1_maintain_reach_int_raw_msb = 10
        self.__rxbeacon0_maintain_reach_int_raw_lsb = 9
        self.__rxbeacon0_maintain_reach_int_raw_msb = 9
    ...
    @property
    def mac_backup_dma_done_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__mac_backup_dma_done_int_raw_msb, self.__mac_backup_dma_done_int_raw_lsb)
    @mac_backup_dma_done_int_raw.setter
    def mac_backup_dma_done_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__mac_backup_dma_done_int_raw_msb, self.__mac_backup_dma_done_int_raw_lsb, value)

    @property
    def rxbeacon3_maintain_reach_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon3_maintain_reach_int_raw_msb, self.__rxbeacon3_maintain_reach_int_raw_lsb)
    @rxbeacon3_maintain_reach_int_raw.setter
    def rxbeacon3_maintain_reach_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon3_maintain_reach_int_raw_msb, self.__rxbeacon3_maintain_reach_int_raw_lsb, value)

    @property
    def rxbeacon2_maintain_reach_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon2_maintain_reach_int_raw_msb, self.__rxbeacon2_maintain_reach_int_raw_lsb)
    @rxbeacon2_maintain_reach_int_raw.setter
    def rxbeacon2_maintain_reach_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon2_maintain_reach_int_raw_msb, self.__rxbeacon2_maintain_reach_int_raw_lsb, value)

    @property
    def rxbeacon1_maintain_reach_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon1_maintain_reach_int_raw_msb, self.__rxbeacon1_maintain_reach_int_raw_lsb)
    @rxbeacon1_maintain_reach_int_raw.setter
    def rxbeacon1_maintain_reach_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon1_maintain_reach_int_raw_msb, self.__rxbeacon1_maintain_reach_int_raw_lsb, value)

    @property
    def rxbeacon0_maintain_reach_int_raw(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon0_maintain_reach_int_raw_msb, self.__rxbeacon0_maintain_reach_int_raw_lsb)
    @rxbeacon0_maintain_reach_int_raw.setter
    def rxbeacon0_maintain_reach_int_raw(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon0_maintain_reach_int_raw_msb, self.__rxbeacon0_maintain_reach_int_raw_lsb, value)
...
class INT_ST_MACPWR(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_PWR_BASE + 0x1ac
        self.__mac_backup_dma_done_int_st_lsb = 13
        self.__mac_backup_dma_done_int_st_msb = 13
        self.__rxbeacon3_maintain_reach_int_st_lsb = 12
        self.__rxbeacon3_maintain_reach_int_st_msb = 12
        self.__rxbeacon2_maintain_reach_int_st_lsb = 11
        self.__rxbeacon2_maintain_reach_int_st_msb = 11
        self.__rxbeacon1_maintain_reach_int_st_lsb = 10
        self.__rxbeacon1_maintain_reach_int_st_msb = 10
        self.__rxbeacon0_maintain_reach_int_st_lsb = 9
        self.__rxbeacon0_maintain_reach_int_st_msb = 9
    ...
    @property
    def mac_backup_dma_done_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__mac_backup_dma_done_int_st_msb, self.__mac_backup_dma_done_int_st_lsb)
    @mac_backup_dma_done_int_st.setter
    def mac_backup_dma_done_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__mac_backup_dma_done_int_st_msb, self.__mac_backup_dma_done_int_st_lsb, value)

    @property
    def rxbeacon3_maintain_reach_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon3_maintain_reach_int_st_msb, self.__rxbeacon3_maintain_reach_int_st_lsb)
    @rxbeacon3_maintain_reach_int_st.setter
    def rxbeacon3_maintain_reach_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon3_maintain_reach_int_st_msb, self.__rxbeacon3_maintain_reach_int_st_lsb, value)

    @property
    def rxbeacon2_maintain_reach_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon2_maintain_reach_int_st_msb, self.__rxbeacon2_maintain_reach_int_st_lsb)
    @rxbeacon2_maintain_reach_int_st.setter
    def rxbeacon2_maintain_reach_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon2_maintain_reach_int_st_msb, self.__rxbeacon2_maintain_reach_int_st_lsb, value)

    @property
    def rxbeacon1_maintain_reach_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon1_maintain_reach_int_st_msb, self.__rxbeacon1_maintain_reach_int_st_lsb)
    @rxbeacon1_maintain_reach_int_st.setter
    def rxbeacon1_maintain_reach_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon1_maintain_reach_int_st_msb, self.__rxbeacon1_maintain_reach_int_st_lsb, value)

    @property
    def rxbeacon0_maintain_reach_int_st(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon0_maintain_reach_int_st_msb, self.__rxbeacon0_maintain_reach_int_st_lsb)
    @rxbeacon0_maintain_reach_int_st.setter
    def rxbeacon0_maintain_reach_int_st(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon0_maintain_reach_int_st_msb, self.__rxbeacon0_maintain_reach_int_st_lsb, value)
...
class INT_CLR_MACPWR(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_PWR_BASE + 0x1b0
        self.__mac_backup_dma_done_int_clr_lsb = 13
        self.__mac_backup_dma_done_int_clr_msb = 13
        self.__rxbeacon3_maintain_reach_int_clr_lsb = 12
        self.__rxbeacon3_maintain_reach_int_clr_msb = 12
        self.__rxbeacon2_maintain_reach_int_clr_lsb = 11
        self.__rxbeacon2_maintain_reach_int_clr_msb = 11
        self.__rxbeacon1_maintain_reach_int_clr_lsb = 10
        self.__rxbeacon1_maintain_reach_int_clr_msb = 10
        self.__rxbeacon0_maintain_reach_int_clr_lsb = 9
        self.__rxbeacon0_maintain_reach_int_clr_msb = 9
    ...
    @property
    def mac_backup_dma_done_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__mac_backup_dma_done_int_clr_msb, self.__mac_backup_dma_done_int_clr_lsb)
    @mac_backup_dma_done_int_clr.setter
    def mac_backup_dma_done_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__mac_backup_dma_done_int_clr_msb, self.__mac_backup_dma_done_int_clr_lsb, value)

    @property
    def rxbeacon3_maintain_reach_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon3_maintain_reach_int_clr_msb, self.__rxbeacon3_maintain_reach_int_clr_lsb)
    @rxbeacon3_maintain_reach_int_clr.setter
    def rxbeacon3_maintain_reach_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon3_maintain_reach_int_clr_msb, self.__rxbeacon3_maintain_reach_int_clr_lsb, value)

    @property
    def rxbeacon2_maintain_reach_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon2_maintain_reach_int_clr_msb, self.__rxbeacon2_maintain_reach_int_clr_lsb)
    @rxbeacon2_maintain_reach_int_clr.setter
    def rxbeacon2_maintain_reach_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon2_maintain_reach_int_clr_msb, self.__rxbeacon2_maintain_reach_int_clr_lsb, value)

    @property
    def rxbeacon1_maintain_reach_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon1_maintain_reach_int_clr_msb, self.__rxbeacon1_maintain_reach_int_clr_lsb)
    @rxbeacon1_maintain_reach_int_clr.setter
    def rxbeacon1_maintain_reach_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon1_maintain_reach_int_clr_msb, self.__rxbeacon1_maintain_reach_int_clr_lsb, value)

    @property
    def rxbeacon0_maintain_reach_int_clr(self):
        return self.__MEM.rdm(self.__addr, self.__rxbeacon0_maintain_reach_int_clr_msb, self.__rxbeacon0_maintain_reach_int_clr_lsb)
    @rxbeacon0_maintain_reach_int_clr.setter
    def rxbeacon0_maintain_reach_int_clr(self, value):
        return self.__MEM.wrm(self.__addr, self.__rxbeacon0_maintain_reach_int_clr_msb, self.__rxbeacon0_maintain_reach_int_clr_lsb, value)
...
class MACCO_EXTERN_CONF0(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_PWR_BASE + 0x1b4
...
class MACCO_EXTERN_CONF1(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        ...
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_PWR_BASE + 0x1b8
...
class MAC_BACKUP_DMA_CONF(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_PWR_BASE + 0x1bc
        self.__reg_mac_backup_dma_en_lsb = 31
        self.__reg_mac_backup_dma_en_msb = 31
        self.__reg_mac_backup_start_lsb = 30
        self.__reg_mac_backup_start_msb = 30
        self.__reg_mac_backup_write_lsb = 29
        self.__reg_mac_backup_write_msb = 29
        self.__reg_mac_backup_mem_base_addr_lsb = 11
        self.__reg_mac_backup_mem_base_addr_msb = 22
        self.__reg_mac_backup_reg_start_addr_lsb = 0
        self.__reg_mac_backup_reg_start_addr_msb = 10
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_mac_backup_dma_en(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_backup_dma_en_msb, self.__reg_mac_backup_dma_en_lsb)
    @reg_mac_backup_dma_en.setter
    def reg_mac_backup_dma_en(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_backup_dma_en_msb, self.__reg_mac_backup_dma_en_lsb, value)

    @property
    def reg_mac_backup_start(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_backup_start_msb, self.__reg_mac_backup_start_lsb)
    @reg_mac_backup_start.setter
    def reg_mac_backup_start(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_backup_start_msb, self.__reg_mac_backup_start_lsb, value)

    @property
    def reg_mac_backup_write(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_backup_write_msb, self.__reg_mac_backup_write_lsb)
    @reg_mac_backup_write.setter
    def reg_mac_backup_write(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_backup_write_msb, self.__reg_mac_backup_write_lsb, value)

    @property
    def reg_mac_backup_mem_base_addr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_backup_mem_base_addr_msb, self.__reg_mac_backup_mem_base_addr_lsb)
    @reg_mac_backup_mem_base_addr.setter
    def reg_mac_backup_mem_base_addr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_backup_mem_base_addr_msb, self.__reg_mac_backup_mem_base_addr_lsb, value)

    @property
    def reg_mac_backup_reg_start_addr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_backup_reg_start_addr_msb, self.__reg_mac_backup_reg_start_addr_lsb)
    @reg_mac_backup_reg_start_addr.setter
    def reg_mac_backup_reg_start_addr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_backup_reg_start_addr_msb, self.__reg_mac_backup_reg_start_addr_lsb, value)
class MAC_BACKUP_DMA_ADDR(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_PWR_BASE + 0x1c0
        self.__reg_mac_backup_mem_start_addr_lsb = 11
        self.__reg_mac_backup_mem_start_addr_msb = 30
        self.__reg_mac_backup_size_lsb = 0
        self.__reg_mac_backup_size_msb = 10
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_mac_backup_mem_start_addr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_backup_mem_start_addr_msb, self.__reg_mac_backup_mem_start_addr_lsb)
    @reg_mac_backup_mem_start_addr.setter
    def reg_mac_backup_mem_start_addr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_backup_mem_start_addr_msb, self.__reg_mac_backup_mem_start_addr_lsb, value)

    @property
    def reg_mac_backup_size(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_backup_size_msb, self.__reg_mac_backup_size_lsb)
    @reg_mac_backup_size.setter
    def reg_mac_backup_size(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_backup_size_msb, self.__reg_mac_backup_size_lsb, value)
class MAC_BACKUP_DMA_DEBUG(object):
    def __init__(self, channel, chipv = "FPGA724_M1"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_PWR_BASE + 0x1c4
        self.__reg_mac_backup_debug_lsb = 0
        self.__reg_mac_backup_debug_msb = 31
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_mac_backup_debug(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_backup_debug_msb, self.__reg_mac_backup_debug_lsb)
    @reg_mac_backup_debug.setter
    def reg_mac_backup_debug(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_backup_debug_msb, self.__reg_mac_backup_debug_lsb, value)
