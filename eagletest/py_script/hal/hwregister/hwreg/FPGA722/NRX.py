...
from hal.hwregister.hwreg.FPGA722.addr_base import *
class NRX(object):
    def __init__(self, channel, chipv = "FPGA722"):
        self.chipv = chipv
        ...
        self.NRXMODUSCALE = NRXMODUSCALE(self.channel, self.chipv)
        ...
        self.NRXPILOTERR0 = NRXPILOTERR0(self.channel, self.chipv)
        self.NRXPILOTERR1 = NRXPILOTERR1(self.channel, self.chipv)
        self.NRXPILOTERR2 = NRXPILOTERR2(self.channel, self.chipv)
        self.NRXPILOTERR3 = NRXPILOTERR3(self.channel, self.chipv)
        self.NRXPILOTERR4 = NRXPILOTERR4(self.channel, self.chipv)
        self.NRXPILOTERR5 = NRXPILOTERR5(self.channel, self.chipv)
        ...
        self.NRXCHANSELTHR = NRXCHANSELTHR(self.channel, self.chipv)
...
class NRXMODUSCALE(object):
    def __init__(self, channel, chipv = "FPGA722"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = NRX_BASE + 0x4c
        self.__reg_64qam_scale_lsb = 24
        self.__reg_64qam_scale_msb = 31
        self.__reg_16qam_scale_lsb = 16
        self.__reg_16qam_scale_msb = 23
        self.__reg_qpsk_scale_lsb = 8
        self.__reg_qpsk_scale_msb = 15
        self.__reg_bpsk_scale_lsb = 0
        self.__reg_bpsk_scale_msb = 7
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_64qam_scale(self):
        return self.__MEM.rdm(self.__addr, self.__reg_64qam_scale_msb, self.__reg_64qam_scale_lsb)
    @reg_64qam_scale.setter
    def reg_64qam_scale(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_64qam_scale_msb, self.__reg_64qam_scale_lsb, value)

    @property
    def reg_16qam_scale(self):
        return self.__MEM.rdm(self.__addr, self.__reg_16qam_scale_msb, self.__reg_16qam_scale_lsb)
    @reg_16qam_scale.setter
    def reg_16qam_scale(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_16qam_scale_msb, self.__reg_16qam_scale_lsb, value)

    @property
    def reg_qpsk_scale(self):
        return self.__MEM.rdm(self.__addr, self.__reg_qpsk_scale_msb, self.__reg_qpsk_scale_lsb)
    @reg_qpsk_scale.setter
    def reg_qpsk_scale(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_qpsk_scale_msb, self.__reg_qpsk_scale_lsb, value)

    @property
    def reg_bpsk_scale(self):
        return self.__MEM.rdm(self.__addr, self.__reg_bpsk_scale_msb, self.__reg_bpsk_scale_lsb)
    @reg_bpsk_scale.setter
    def reg_bpsk_scale(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_bpsk_scale_msb, self.__reg_bpsk_scale_lsb, value)
...
class NRXPILOTERR0(object):
    def __init__(self, channel, chipv = "FPGA722"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = NRX_BASE + 0x60
        self.__pilot_ph_err0_lsb = 0
        self.__pilot_ph_err0_msb = 20
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def pilot_ph_err0(self):
        return self.__MEM.rdm(self.__addr, self.__pilot_ph_err0_msb, self.__pilot_ph_err0_lsb)
    @pilot_ph_err0.setter
    def pilot_ph_err0(self, value):
        return self.__MEM.wrm(self.__addr, self.__pilot_ph_err0_msb, self.__pilot_ph_err0_lsb, value)
class NRXPILOTERR1(object):
    def __init__(self, channel, chipv = "FPGA722"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = NRX_BASE + 0x64
        self.__pilot_ph_err1_lsb = 0
        self.__pilot_ph_err1_msb = 20
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def pilot_ph_err1(self):
        return self.__MEM.rdm(self.__addr, self.__pilot_ph_err1_msb, self.__pilot_ph_err1_lsb)
    @pilot_ph_err1.setter
    def pilot_ph_err1(self, value):
        return self.__MEM.wrm(self.__addr, self.__pilot_ph_err1_msb, self.__pilot_ph_err1_lsb, value)
class NRXPILOTERR2(object):
    def __init__(self, channel, chipv = "FPGA722"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = NRX_BASE + 0x68
        self.__pilot_ph_err2_lsb = 0
        self.__pilot_ph_err2_msb = 20
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def pilot_ph_err2(self):
        return self.__MEM.rdm(self.__addr, self.__pilot_ph_err2_msb, self.__pilot_ph_err2_lsb)
    @pilot_ph_err2.setter
    def pilot_ph_err2(self, value):
        return self.__MEM.wrm(self.__addr, self.__pilot_ph_err2_msb, self.__pilot_ph_err2_lsb, value)
class NRXPILOTERR3(object):
    def __init__(self, channel, chipv = "FPGA722"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = NRX_BASE + 0x6c
        self.__pilot_ph_err3_lsb = 0
        self.__pilot_ph_err3_msb = 20
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def pilot_ph_err3(self):
        return self.__MEM.rdm(self.__addr, self.__pilot_ph_err3_msb, self.__pilot_ph_err3_lsb)
    @pilot_ph_err3.setter
    def pilot_ph_err3(self, value):
        return self.__MEM.wrm(self.__addr, self.__pilot_ph_err3_msb, self.__pilot_ph_err3_lsb, value)
class NRXPILOTERR4(object):
    def __init__(self, channel, chipv = "FPGA722"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = NRX_BASE + 0x70
        self.__pilot_ph_err4_lsb = 0
        self.__pilot_ph_err4_msb = 20
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def pilot_ph_err4(self):
        return self.__MEM.rdm(self.__addr, self.__pilot_ph_err4_msb, self.__pilot_ph_err4_lsb)
    @pilot_ph_err4.setter
    def pilot_ph_err4(self, value):
        return self.__MEM.wrm(self.__addr, self.__pilot_ph_err4_msb, self.__pilot_ph_err4_lsb, value)
class NRXPILOTERR5(object):
    def __init__(self, channel, chipv = "FPGA722"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = NRX_BASE + 0x74
        self.__pilot_ph_err5_lsb = 0
        self.__pilot_ph_err5_msb = 20
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def pilot_ph_err5(self):
        return self.__MEM.rdm(self.__addr, self.__pilot_ph_err5_msb, self.__pilot_ph_err5_lsb)
    @pilot_ph_err5.setter
    def pilot_ph_err5(self, value):
        return self.__MEM.wrm(self.__addr, self.__pilot_ph_err5_msb, self.__pilot_ph_err5_lsb, value)
...
class NRXPILOTCONF0(object):
    def __init__(self, channel, chipv = "FPGA722"):
        ...
        self.__reg_sym_max_num_lsb = 24
        self.__reg_sym_max_num_msb = 31
    ...
    @property
    def reg_sym_max_num(self):
        return self.__MEM.rdm(self.__addr, self.__reg_sym_max_num_msb, self.__reg_sym_max_num_lsb)
    @reg_sym_max_num.setter
    def reg_sym_max_num(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_sym_max_num_msb, self.__reg_sym_max_num_lsb, value)
...
class NRXCLKGATE(object):
    def __init__(self, channel, chipv = "FPGA722"):
        ...
        self.__reg_tdm_corr_force_clk_lsb = 3
        self.__reg_tdm_corr_force_clk_msb = 3
    ...
    @property
    def reg_tdm_corr_force_clk(self):
        return self.__MEM.rdm(self.__addr, self.__reg_tdm_corr_force_clk_msb, self.__reg_tdm_corr_force_clk_lsb)
    @reg_tdm_corr_force_clk.setter
    def reg_tdm_corr_force_clk(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_tdm_corr_force_clk_msb, self.__reg_tdm_corr_force_clk_lsb, value)
...
class NRXCHANSELTHR(object):
    def __init__(self, channel, chipv = "FPGA722"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = NRX_BASE + 0x120
        self.__reg_chan_filter_off_thr_lsb = 8
        self.__reg_chan_filter_off_thr_msb = 15
    ...
    @property
    def reg_chan_filter_off_thr(self):
        return self.__MEM.rdm(self.__addr, self.__reg_chan_filter_off_thr_msb, self.__reg_chan_filter_off_thr_lsb)
    @reg_chan_filter_off_thr.setter
    def reg_chan_filter_off_thr(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_chan_filter_off_thr_msb, self.__reg_chan_filter_off_thr_lsb, value)
