...
class AGCPWR_CTRL9(object):
    def __init__(self, channel, chipv = "FPGA723"):
        ...
        self.__reg_rest_fine_pwr_sel_lsb = 30
        self.__reg_rest_fine_pwr_sel_msb = 31
        self.__reg_pwr_drop_thr_bt_lsb = 25
        self.__reg_pwr_drop_thr_bt_msb = 29
        self.__reg_pwr_restart_thr_bt_lsb = 20
        self.__reg_pwr_restart_thr_bt_msb = 24
