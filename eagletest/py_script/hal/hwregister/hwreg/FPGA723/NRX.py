...
class NRXFTE1(object):
    def __init__(self, channel, chipv = "FPGA723"):
        ...
        self.__reg_non_gi_rot_en_lsb = 14
        self.__reg_non_gi_rot_en_msb = 14
    ...
    @property
    def reg_non_gi_rot_en(self):
        return self.__MEM.rdm(self.__addr, self.__reg_non_gi_rot_en_msb, self.__reg_non_gi_rot_en_lsb)
    @reg_non_gi_rot_en.setter
    def reg_non_gi_rot_en(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_non_gi_rot_en_msb, self.__reg_non_gi_rot_en_lsb, value)
