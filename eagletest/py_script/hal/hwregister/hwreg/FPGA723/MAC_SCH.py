...
class MAC_SCH(object):
    def __init__(self, channel, chipv = "FPGA723"):
        ...
        self.MACRX_PDCTRL = MACRX_PDCTRL(self.channel, self.chipv)
        ...
        self.MACAUTOACK_TIMER_FC = MACAUTOACK_TIMER_FC(self.channel, self.chipv)
...
class MACOPTIONS(object):
    def __init__(self, channel, chipv = "FPGA723"):
        ...
        self.__reg_rxstart_bea_use_bb_lsb = 22
        self.__reg_rxstart_bea_use_bb_msb = 22
        self.__reg_bbtxstop_delay_lsb = 18
        self.__reg_bbtxstop_delay_msb = 21
    ...
    @property
    def reg_bbtxstop_delay(self):
        return self.__MEM.rdm(self.__addr, self.__reg_bbtxstop_delay_msb, self.__reg_bbtxstop_delay_lsb)
    @reg_bbtxstop_delay.setter
    def reg_bbtxstop_delay(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_bbtxstop_delay_msb, self.__reg_bbtxstop_delay_lsb, value)
...
class MACRX_PDCTRL(object):
    def __init__(self, channel, chipv = "FPGA723"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1b4
        self.__reg_mac_apb_force_pu_lsb = 9
        self.__reg_mac_apb_force_pu_msb = 9
        self.__reg_mac_apb_force_pd_lsb = 8
        self.__reg_mac_apb_force_pd_msb = 8
        self.__reg_tx_bbfifo_force_pu_lsb = 7
        self.__reg_tx_bbfifo_force_pu_msb = 7
        self.__reg_tx_bbfifo_force_pd_lsb = 6
        self.__reg_tx_bbfifo_force_pd_msb = 6
        self.__reg_mac_sec_core_force_pu_lsb = 5
        self.__reg_mac_sec_core_force_pu_msb = 5
        self.__reg_mac_sec_core_force_pd_lsb = 4
        self.__reg_mac_sec_core_force_pd_msb = 4
        self.__reg_mac_sec_rx_force_pu_lsb = 3
        self.__reg_mac_sec_rx_force_pu_msb = 3
        self.__reg_mac_sec_rx_force_pd_lsb = 2
        self.__reg_mac_sec_rx_force_pd_msb = 2
        self.__reg_rx_bbfifo_force_pu_lsb = 1
        self.__reg_rx_bbfifo_force_pu_msb = 1
        self.__reg_rx_bbfifo_force_pd_lsb = 0
        self.__reg_rx_bbfifo_force_pd_msb = 0
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_mac_apb_force_pu(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_apb_force_pu_msb, self.__reg_mac_apb_force_pu_lsb)
    @reg_mac_apb_force_pu.setter
    def reg_mac_apb_force_pu(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_apb_force_pu_msb, self.__reg_mac_apb_force_pu_lsb, value)

    @property
    def reg_mac_apb_force_pd(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_apb_force_pd_msb, self.__reg_mac_apb_force_pd_lsb)
    @reg_mac_apb_force_pd.setter
    def reg_mac_apb_force_pd(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_apb_force_pd_msb, self.__reg_mac_apb_force_pd_lsb, value)

    @property
    def reg_tx_bbfifo_force_pu(self):
        return self.__MEM.rdm(self.__addr, self.__reg_tx_bbfifo_force_pu_msb, self.__reg_tx_bbfifo_force_pu_lsb)
    @reg_tx_bbfifo_force_pu.setter
    def reg_tx_bbfifo_force_pu(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_tx_bbfifo_force_pu_msb, self.__reg_tx_bbfifo_force_pu_lsb, value)

    @property
    def reg_tx_bbfifo_force_pd(self):
        return self.__MEM.rdm(self.__addr, self.__reg_tx_bbfifo_force_pd_msb, self.__reg_tx_bbfifo_force_pd_lsb)
    @reg_tx_bbfifo_force_pd.setter
    def reg_tx_bbfifo_force_pd(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_tx_bbfifo_force_pd_msb, self.__reg_tx_bbfifo_force_pd_lsb, value)

    @property
    def reg_mac_sec_core_force_pu(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_sec_core_force_pu_msb, self.__reg_mac_sec_core_force_pu_lsb)
    @reg_mac_sec_core_force_pu.setter
    def reg_mac_sec_core_force_pu(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_sec_core_force_pu_msb, self.__reg_mac_sec_core_force_pu_lsb, value)

    @property
    def reg_mac_sec_core_force_pd(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_sec_core_force_pd_msb, self.__reg_mac_sec_core_force_pd_lsb)
    @reg_mac_sec_core_force_pd.setter
    def reg_mac_sec_core_force_pd(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_sec_core_force_pd_msb, self.__reg_mac_sec_core_force_pd_lsb, value)

    @property
    def reg_mac_sec_rx_force_pu(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_sec_rx_force_pu_msb, self.__reg_mac_sec_rx_force_pu_lsb)
    @reg_mac_sec_rx_force_pu.setter
    def reg_mac_sec_rx_force_pu(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_sec_rx_force_pu_msb, self.__reg_mac_sec_rx_force_pu_lsb, value)

    @property
    def reg_mac_sec_rx_force_pd(self):
        return self.__MEM.rdm(self.__addr, self.__reg_mac_sec_rx_force_pd_msb, self.__reg_mac_sec_rx_force_pd_lsb)
    @reg_mac_sec_rx_force_pd.setter
    def reg_mac_sec_rx_force_pd(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_mac_sec_rx_force_pd_msb, self.__reg_mac_sec_rx_force_pd_lsb, value)

    @property
    def reg_rx_bbfifo_force_pu(self):
        return self.__MEM.rdm(self.__addr, self.__reg_rx_bbfifo_force_pu_msb, self.__reg_rx_bbfifo_force_pu_lsb)
    @reg_rx_bbfifo_force_pu.setter
    def reg_rx_bbfifo_force_pu(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_rx_bbfifo_force_pu_msb, self.__reg_rx_bbfifo_force_pu_lsb, value)

    @property
    def reg_rx_bbfifo_force_pd(self):
        return self.__MEM.rdm(self.__addr, self.__reg_rx_bbfifo_force_pd_msb, self.__reg_rx_bbfifo_force_pd_lsb)
    @reg_rx_bbfifo_force_pd.setter
    def reg_rx_bbfifo_force_pd(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_rx_bbfifo_force_pd_msb, self.__reg_rx_bbfifo_force_pd_lsb, value)
...
class MACAUTOACK_TIMER5_CYC(object):
    def __init__(self, channel, chipv = "FPGA723"):
        ...
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1ec
...
class MACAUTOACK_TIMER_FC(object):
    def __init__(self, channel, chipv = "FPGA723"):
        self.chipv = chipv
        self.channel = channel
        self.__MEM = MEM(self.channel, self.chipv)
        self.__addr = MAC_SCH_BASE + 0x1f0
        self.__reg_autoack_timer_framctrl_mask_lsb = 8
        self.__reg_autoack_timer_framctrl_mask_msb = 15
        self.__reg_autoack_timer_framctrl_lsb = 0
        self.__reg_autoack_timer_framctrl_msb = 7
    @property
    def reg(self):
        return self.__MEM.rdm(self.__addr, 31, 0)
    @reg.setter
    ...
    @property
    def reg_autoack_timer_framctrl_mask(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_timer_framctrl_mask_msb, self.__reg_autoack_timer_framctrl_mask_lsb)
    @reg_autoack_timer_framctrl_mask.setter
    def reg_autoack_timer_framctrl_mask(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_timer_framctrl_mask_msb, self.__reg_autoack_timer_framctrl_mask_lsb, value)

    @property
    def reg_autoack_timer_framctrl(self):
        return self.__MEM.rdm(self.__addr, self.__reg_autoack_timer_framctrl_msb, self.__reg_autoack_timer_framctrl_lsb)
    @reg_autoack_timer_framctrl.setter
    def reg_autoack_timer_framctrl(self, value):
        return self.__MEM.wrm(self.__addr, self.__reg_autoack_timer_framctrl_msb, self.__reg_autoack_timer_framctrl_lsb, value)
