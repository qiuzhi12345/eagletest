...
class BIAS(object):
    def __init__(self, channel, chipv = "CHIP724"):
        ...
        self.__dreg_2p2_lsb = 4
        self.__dreg_2p2_msb = 7
        self.__dreg_2p2_addr = 0x1
    ...
    @property
    def dreg_2p2(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__dreg_2p2_addr, self.__dreg_2p2_msb, self.__dreg_2p2_lsb)
    @dreg_2p2.setter
    def dreg_2p2(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__dreg_2p2_addr, self.__dreg_2p2_msb, self.__dreg_2p2_lsb, value)
