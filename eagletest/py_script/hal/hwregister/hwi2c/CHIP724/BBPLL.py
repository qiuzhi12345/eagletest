...
class BBPLL(object):
    ...
    @property
    def en_usb(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__en_usb_addr, self.__en_usb_msb, self.__en_usb_lsb)
    @en_usb.setter
    def en_usb(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__en_usb_addr, self.__en_usb_msb, self.__en_usb_lsb, value)
