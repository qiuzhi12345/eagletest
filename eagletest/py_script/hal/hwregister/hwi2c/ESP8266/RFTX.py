...
class RFTX(object):
    def __init__(self, channel, chipv = "ESP8266"):
        ...
        self.__PA2G_ICT_BIAS_PMOS_lsb = 4
        self.__PA2G_ICT_BIAS_PMOS_msb = 7
        self.__PA2G_ICT_BIAS_PMOS_addr = 0x4
        ...
        self.__PA2G_STG0_SEL_ICGM_N_lsb = 7
        self.__PA2G_STG0_SEL_ICGM_N_msb = 7
        self.__PA2G_STG0_SEL_ICGM_N_addr = 0x6
        ...
        self.__PWDET_ICT_OUTPUT_lsb = 4
        self.__PWDET_ICT_OUTPUT_msb = 5
        self.__PWDET_ICT_OUTPUT_addr = 0xa
        self.__PWDET_VCT_REF_lsb = 6
        self.__PWDET_VCT_REF_msb = 7
        self.__PWDET_VCT_REF_addr = 0xa
        self.__PA2G_CCT2F_STG0_GATE_lsb = 0
        self.__PA2G_CCT2F_STG0_GATE_msb = 3
        self.__PA2G_CCT2F_STG0_GATE_addr = 0xb
    ...
    @property
    def PA2G_ICT_BIAS_PMOS(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__PA2G_ICT_BIAS_PMOS_addr, self.__PA2G_ICT_BIAS_PMOS_msb, self.__PA2G_ICT_BIAS_PMOS_lsb)
    @PA2G_ICT_BIAS_PMOS.setter
    def PA2G_ICT_BIAS_PMOS(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__PA2G_ICT_BIAS_PMOS_addr, self.__PA2G_ICT_BIAS_PMOS_msb, self.__PA2G_ICT_BIAS_PMOS_lsb, value)
    ...
    @property
    def PA2G_STG0_SEL_ICGM_N(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__PA2G_STG0_SEL_ICGM_N_addr, self.__PA2G_STG0_SEL_ICGM_N_msb, self.__PA2G_STG0_SEL_ICGM_N_lsb)
    @PA2G_STG0_SEL_ICGM_N.setter
    def PA2G_STG0_SEL_ICGM_N(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__PA2G_STG0_SEL_ICGM_N_addr, self.__PA2G_STG0_SEL_ICGM_N_msb, self.__PA2G_STG0_SEL_ICGM_N_lsb, value)
    ...
    @property
    def PWDET_ICT_OUTPUT(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__PWDET_ICT_OUTPUT_addr, self.__PWDET_ICT_OUTPUT_msb, self.__PWDET_ICT_OUTPUT_lsb)
    @PWDET_ICT_OUTPUT.setter
    def PWDET_ICT_OUTPUT(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__PWDET_ICT_OUTPUT_addr, self.__PWDET_ICT_OUTPUT_msb, self.__PWDET_ICT_OUTPUT_lsb, value)

    @property
    def PWDET_VCT_REF(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__PWDET_VCT_REF_addr, self.__PWDET_VCT_REF_msb, self.__PWDET_VCT_REF_lsb)
    @PWDET_VCT_REF.setter
    def PWDET_VCT_REF(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__PWDET_VCT_REF_addr, self.__PWDET_VCT_REF_msb, self.__PWDET_VCT_REF_lsb, value)

    @property
    def PA2G_CCT2F_STG0_GATE(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__PA2G_CCT2F_STG0_GATE_addr, self.__PA2G_CCT2F_STG0_GATE_msb, self.__PA2G_CCT2F_STG0_GATE_lsb)
    @PA2G_CCT2F_STG0_GATE.setter
    def PA2G_CCT2F_STG0_GATE(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__PA2G_CCT2F_STG0_GATE_addr, self.__PA2G_CCT2F_STG0_GATE_msb, self.__PA2G_CCT2F_STG0_GATE_lsb, value)
