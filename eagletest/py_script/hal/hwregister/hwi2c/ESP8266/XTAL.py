...
class XTAL(object):
    def __init__(self, channel, chipv = "ESP8266"):
        ...
        self.__enb_sck_lsb = 1
        self.__enb_sck_msb = 1
        self.__enb_sck_addr = 0x1
    ...
    @property
    def enb_sck(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__enb_sck_addr, self.__enb_sck_msb, self.__enb_sck_lsb)
    @enb_sck.setter
    def enb_sck(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__enb_sck_addr, self.__enb_sck_msb, self.__enb_sck_lsb, value)
