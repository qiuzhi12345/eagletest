...
class RFPLL(object):
    def __init__(self, channel, chipv = "ESP8266"):
        ...
        self.__ir_enx_cap_lsb = 7
        self.__ir_enx_cap_msb = 7
        self.__ir_enx_cap_addr = 0x0
        self.__ir_cap_ext_lsb = 0
        self.__ir_cap_ext_msb = 7
        self.__ir_cap_ext_addr = 0x1
        self.__ir_dac_ext_lsb = 0
        self.__ir_dac_ext_msb = 4
        ...
        self.__xpd_bias_cal_lsb = 7
        self.__xpd_bias_cal_msb = 7
        self.__xpd_bias_cal_addr = 0x3
        self.__ir_ext_dchgp_lsb = 0
        self.__ir_ext_dchgp_msb = 2
        self.__ir_ext_dchgp_addr = 0x4
        self.__ir_enx_dchgp_lsb = 3
        self.__ir_enx_dchgp_msb = 3
        self.__ir_enx_dchgp_addr = 0x4
        ...
        self.__or_pll_dac_msb = 4
        self.__or_pll_dac_addr = 0x6
        self.__or_pll_dac_err_lsb = 0
        self.__or_pll_dac_err_msb = 0
        self.__or_pll_dac_err_addr = 0x7
        self.__or_pll_dac_ovf_lsb = 1
        self.__or_pll_dac_ovf_msb = 1
        self.__or_pll_dac_ovf_addr = 0x7
        self.__or_pll_dac_udf_lsb = 2
        self.__or_pll_dac_udf_msb = 2
        self.__or_pll_dac_udf_addr = 0x7
        self.__or_pll_cap_err_lsb = 3
        self.__or_pll_cap_err_msb = 3
        self.__or_pll_cap_err_addr = 0x7
        self.__or_pll_cap_ovf_lsb = 4
        self.__or_pll_cap_ovf_msb = 4
        self.__or_pll_cap_ovf_addr = 0x7
        self.__or_pll_cap_udf_lsb = 5
        self.__or_pll_cap_udf_msb = 5
        self.__or_pll_cap_udf_addr = 0x7
        self.__or_pll_amp_end_lsb = 6
        self.__or_pll_amp_end_msb = 6
        self.__or_pll_amp_end_addr = 0x7
        self.__or_pll_cal_end_lsb = 7
        self.__or_pll_cal_end_msb = 7
        self.__or_pll_cal_end_addr = 0x7
        self.__ir_ext_vtr_dbias_lsb = 0
        self.__ir_ext_vtr_dbias_msb = 4
        self.__ir_ext_vtr_dbias_addr = 0x8
        self.__ir_enx_vtr_dbias_lsb = 7
        self.__ir_enx_vtr_dbias_msb = 7
        self.__ir_enx_vtr_dbias_addr = 0x8
        self.__or_vtr_dbias_lsb = 0
        self.__or_vtr_dbias_msb = 4
        self.__or_vtr_dbias_addr = 0x9
        self.__or_vtr_cal_end_lsb = 5
        self.__or_vtr_cal_end_msb = 5
        self.__or_vtr_cal_end_addr = 0x9
        self.__or_vtr_cal_udf_lsb = 6
        self.__or_vtr_cal_udf_msb = 6
        self.__or_vtr_cal_udf_addr = 0x9
        self.__or_vtr_cal_ovf_lsb = 7
        self.__or_vtr_cal_ovf_msb = 7
        self.__or_vtr_cal_ovf_addr = 0x9
        self.__ir_vtr_rstb_lsb = 0
        self.__ir_vtr_rstb_msb = 0
        self.__ir_vtr_rstb_addr = 0xa
        self.__ir_vtr_start_lsb = 1
        self.__ir_vtr_start_msb = 1
        self.__ir_vtr_start_addr = 0xa
        self.__ir_vtr_pol_lsb = 2
        self.__ir_vtr_pol_msb = 2
        self.__ir_vtr_pol_addr = 0xa
        self.__dhref_lsb = 4
        self.__dhref_msb = 5
    ...
    @property
    def xpd_bias_cal(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__xpd_bias_cal_addr, self.__xpd_bias_cal_msb, self.__xpd_bias_cal_lsb)
    @xpd_bias_cal.setter
    def xpd_bias_cal(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__xpd_bias_cal_addr, self.__xpd_bias_cal_msb, self.__xpd_bias_cal_lsb, value)
    ...
    @property
    def ir_enx_dchgp(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__ir_enx_dchgp_addr, self.__ir_enx_dchgp_msb, self.__ir_enx_dchgp_lsb)
    @ir_enx_dchgp.setter
    def ir_enx_dchgp(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__ir_enx_dchgp_addr, self.__ir_enx_dchgp_msb, self.__ir_enx_dchgp_lsb, value)
    ...
    @property
    def or_pll_dac_err(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__or_pll_dac_err_addr, self.__or_pll_dac_err_msb, self.__or_pll_dac_err_lsb)
    @or_pll_dac_err.setter
    def or_pll_dac_err(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__or_pll_dac_err_addr, self.__or_pll_dac_err_msb, self.__or_pll_dac_err_lsb, value)

    @property
    def or_pll_dac_ovf(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__or_pll_dac_ovf_addr, self.__or_pll_dac_ovf_msb, self.__or_pll_dac_ovf_lsb)
    @or_pll_dac_ovf.setter
    def or_pll_dac_ovf(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__or_pll_dac_ovf_addr, self.__or_pll_dac_ovf_msb, self.__or_pll_dac_ovf_lsb, value)

    @property
    def or_pll_dac_udf(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__or_pll_dac_udf_addr, self.__or_pll_dac_udf_msb, self.__or_pll_dac_udf_lsb)
    @or_pll_dac_udf.setter
    def or_pll_dac_udf(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__or_pll_dac_udf_addr, self.__or_pll_dac_udf_msb, self.__or_pll_dac_udf_lsb, value)

    @property
    def or_pll_cap_err(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__or_pll_cap_err_addr, self.__or_pll_cap_err_msb, self.__or_pll_cap_err_lsb)
    @or_pll_cap_err.setter
    def or_pll_cap_err(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__or_pll_cap_err_addr, self.__or_pll_cap_err_msb, self.__or_pll_cap_err_lsb, value)

    @property
    def or_pll_cap_ovf(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__or_pll_cap_ovf_addr, self.__or_pll_cap_ovf_msb, self.__or_pll_cap_ovf_lsb)
    @or_pll_cap_ovf.setter
    def or_pll_cap_ovf(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__or_pll_cap_ovf_addr, self.__or_pll_cap_ovf_msb, self.__or_pll_cap_ovf_lsb, value)

    @property
    def or_pll_cap_udf(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__or_pll_cap_udf_addr, self.__or_pll_cap_udf_msb, self.__or_pll_cap_udf_lsb)
    @or_pll_cap_udf.setter
    def or_pll_cap_udf(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__or_pll_cap_udf_addr, self.__or_pll_cap_udf_msb, self.__or_pll_cap_udf_lsb, value)
    ...
    @property
    def ir_ext_vtr_dbias(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__ir_ext_vtr_dbias_addr, self.__ir_ext_vtr_dbias_msb, self.__ir_ext_vtr_dbias_lsb)
    @ir_ext_vtr_dbias.setter
    def ir_ext_vtr_dbias(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__ir_ext_vtr_dbias_addr, self.__ir_ext_vtr_dbias_msb, self.__ir_ext_vtr_dbias_lsb, value)

    @property
    def ir_enx_vtr_dbias(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__ir_enx_vtr_dbias_addr, self.__ir_enx_vtr_dbias_msb, self.__ir_enx_vtr_dbias_lsb)
    @ir_enx_vtr_dbias.setter
    def ir_enx_vtr_dbias(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__ir_enx_vtr_dbias_addr, self.__ir_enx_vtr_dbias_msb, self.__ir_enx_vtr_dbias_lsb, value)

    @property
    def or_vtr_dbias(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__or_vtr_dbias_addr, self.__or_vtr_dbias_msb, self.__or_vtr_dbias_lsb)
    @or_vtr_dbias.setter
    def or_vtr_dbias(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__or_vtr_dbias_addr, self.__or_vtr_dbias_msb, self.__or_vtr_dbias_lsb, value)

    @property
    def or_vtr_cal_end(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__or_vtr_cal_end_addr, self.__or_vtr_cal_end_msb, self.__or_vtr_cal_end_lsb)
    @or_vtr_cal_end.setter
    def or_vtr_cal_end(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__or_vtr_cal_end_addr, self.__or_vtr_cal_end_msb, self.__or_vtr_cal_end_lsb, value)

    @property
    def or_vtr_cal_udf(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__or_vtr_cal_udf_addr, self.__or_vtr_cal_udf_msb, self.__or_vtr_cal_udf_lsb)
    @or_vtr_cal_udf.setter
    def or_vtr_cal_udf(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__or_vtr_cal_udf_addr, self.__or_vtr_cal_udf_msb, self.__or_vtr_cal_udf_lsb, value)

    @property
    def or_vtr_cal_ovf(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__or_vtr_cal_ovf_addr, self.__or_vtr_cal_ovf_msb, self.__or_vtr_cal_ovf_lsb)
    @or_vtr_cal_ovf.setter
    def or_vtr_cal_ovf(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__or_vtr_cal_ovf_addr, self.__or_vtr_cal_ovf_msb, self.__or_vtr_cal_ovf_lsb, value)

    @property
    def ir_vtr_rstb(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__ir_vtr_rstb_addr, self.__ir_vtr_rstb_msb, self.__ir_vtr_rstb_lsb)
    @ir_vtr_rstb.setter
    def ir_vtr_rstb(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__ir_vtr_rstb_addr, self.__ir_vtr_rstb_msb, self.__ir_vtr_rstb_lsb, value)

    @property
    def ir_vtr_start(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__ir_vtr_start_addr, self.__ir_vtr_start_msb, self.__ir_vtr_start_lsb)
    @ir_vtr_start.setter
    def ir_vtr_start(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__ir_vtr_start_addr, self.__ir_vtr_start_msb, self.__ir_vtr_start_lsb, value)

    @property
    def ir_vtr_pol(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__ir_vtr_pol_addr, self.__ir_vtr_pol_msb, self.__ir_vtr_pol_lsb)
    @ir_vtr_pol.setter
    def ir_vtr_pol(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__ir_vtr_pol_addr, self.__ir_vtr_pol_msb, self.__ir_vtr_pol_lsb, value)
