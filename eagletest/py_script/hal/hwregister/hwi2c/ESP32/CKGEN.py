...
class CKGEN(object):
    def __init__(self, channel, chipv = "ESP32"):
        ...
        self.__fc_counts_en_lsb = 0
        self.__fc_counts_en_msb = 7
        self.__fc_counts_en_addr = 0x3
        self.__fc_counts_en_lsb = 0
        self.__fc_counts_en_msb = 1
        self.__fc_counts_en_addr = 0x4
        ...
        self.__fc_cint_lsb = 0
        self.__fc_cint_msb = 7
        self.__fc_cint_addr = 0x5
        self.__fc_cint_lsb = 0
        self.__fc_cint_msb = 5
        self.__fc_cint_addr = 0x6
    ...
    @property
    def fc_counts_en(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__fc_counts_en_addr, self.__fc_counts_en_msb, self.__fc_counts_en_lsb)
    @fc_counts_en.setter
    def fc_counts_en(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__fc_counts_en_addr, self.__fc_counts_en_msb, self.__fc_counts_en_lsb, value)
    ...
    @property
    def fc_cint(self):
        return self.__I2C.i2c_rdm(self.__base , self.__hostid ,self.__fc_cint_addr, self.__fc_cint_msb, self.__fc_cint_lsb)
    @fc_cint.setter
    def fc_cint(self, value):
        return self.__I2C.i2c_wrm(self.__base , self.__hostid ,self.__fc_cint_addr, self.__fc_cint_msb, self.__fc_cint_lsb, value)
